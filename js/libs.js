function numberRoller(e) {
    var t = $(".roller-title-number-" + e).attr("data-min"), n = $(".roller-title-number-" + e).attr("data-max"),
...
function setFilter(e, t, n) {
    var i = uncamel(t), o = jQuery.browser.mozilla ? "" : jQuery.CSS.sfx;
    e[o + "filter"] = e[o + "filter"] || "", n = setUnit(n > jQuery.CSS.filters[t].max ? jQuery.CSS.filters[t].max : n, jQuery.CSS.filters[t].unit), e[o + "filter"] += i + "(" + n + ") ", delete e[t]
}

function initHeader() {
    width = $headerSizer.width(), height = $headerSizer.height(), canvas = document.getElementById("particles"), canvas.width = width, canvas.height = height, ctx = canvas.getContext("2d"), circles = [];
...
function resize() {
    width = $headerSizer.width(), height = $headerSizer.height(), canvas.width = width, canvas.height = height
}
...
function Circle() {
    function e() {
        t.pos.x = Math.random() * width, t.pos.y = height + 100 * Math.random(), t.alpha = .1 + .3 * Math.random(), t.scale = .1 + .3 * Math.random(), t.velocity = Math.random()
    }
    ...
    !function () {
        ...
        t.alpha <= 0 && e(), t.pos.y -= t.velocity, t.alpha -= 4e-4, ctx.beginPath(), ctx.arc(t.pos.x, t.pos.y, 10 * t.scale, 0, 2 * Math.PI, !1), ctx.fillStyle = "rgba(255,255,255," + t.alpha + ")", ctx.fill()
    }
}
...
window.Modernizr = function (e, t, n) {
    ...
    function c() {
        f.input = function (n) {
            ...
            return Y.list && (Y.list = !(!t.createElement("datalist") || !e.HTMLDataListElement)), Y
        }("autocomplete autofocus list placeholder max min multiple pattern required step".split(" ")), f.inputtypes = function (e) {
            for (var i, o, r, s = 0, a = e.length; a > s; s++) w.setAttribute("type", o = e[s]), i = "text" !== w.type, i && (w.value = T, w.style.cssText = "position:absolute;visibility:hidden;", /^range$/.test(o) && w.style.WebkitAppearance !== n ? (m.appendChild(w), r = t.defaultView, i = r.getComputedStyle && "textfield" !== r.getComputedStyle(w, null).WebkitAppearance && 0 !== w.offsetHeight, m.removeChild(w)) : /^(search|tel)$/.test(o) || (i = /^(url|email)$/.test(o) ? w.checkValidity && !1 === w.checkValidity() : w.value != T)), I[e[s]] = !!i;
            return I
        }("search tel url email datetime date month week time datetime-local number range color".split(" "))
    }

    var d, p, h = "2.8.3", f = {}, g = !0, m = t.documentElement, y = "modernizr", v = t.createElement(y), b = v.style,
        w = t.createElement("input"), T = ":)", x = {}.toString, P = " -webkit- -moz- -o- -ms- ".split(" "),
        S = "Webkit Moz O ms", C = S.split(" "), k = S.toLowerCase().split(" "),
        j = {svg: "http://www.w3.org/2000/svg"}, _ = {}, I = {}, Y = {}, O = [], E = O.slice,
        A = function (e, n, i, o) {
            var r, s, a, l, u = t.createElement("div"), c = t.body, d = c || t.createElement("body");
            if (parseInt(i, 10)) for (; i--;) a = t.createElement("div"), a.id = o ? o[i] : y + (i + 1), u.appendChild(a);
            return r = ["&#173;", '<style id="s', y, '">', e, "</style>"].join(""), u.id = y, (c ? u : d).innerHTML += r, d.appendChild(u), c || (d.style.background = "", d.style.overflow = "hidden", l = m.style.overflow, m.style.overflow = "hidden", m.appendChild(d)), s = n(u, e), c ? u.parentNode.removeChild(u) : (d.parentNode.removeChild(d), m.style.overflow = l), !!s
        }, $ = function (t) {
    ...
    p = r(Q, "undefined") || r(Q.call, "undefined") ? function (e, t) {
        ...
        var n = E.call(arguments, 1), i = function () {
            if (this instanceof i) {
                ...
                var r = new o, s = t.apply(r, n.concat(E.call(arguments)));
        ...
        return i((e + "-webkit- ".split(" ").join("gradient(linear,left top,right bottom,from(#9f9),to(white));" + e) + P.join("linear-gradient(left top,#9f9, white);" + e)).slice(0, -e.length)), s(b.backgroundImage, "gradient")
    ...
    return f.input || c(), f.addTest = function (e, t) {
        if ("object" == typeof e) for (var i in e) p(e, i) && f.addTest(i, e[i]); else {
            ...
            t = "function" == typeof t ? t() : t, void 0 !== g && g && (m.className += " " + (t ? "" : "no-") + e), f[e] = t
        }
        return f
    }, i(""), v = w = null, function (e, t) {
        function n(e, t) {
        ...
        function l(e) {
            e || (e = t);
            var i = o(e);
            return !v.shivCSS || u || i.hasCSS || (i.hasCSS = !!n(e, "article,aside,dialog,figcaption,figure,footer,header,hgroup,main,nav,section{display:block}mark{background:#FF0;color:#000}template{display:none}")), c || a(e, i), e
        }

        var u, c, d = "3.7.0", p = e.html5 || {},
        ...
        e.html5 = v, l(t)
    }(this, t), f._version = h, f._prefixes = P, f._domPrefixes = k, f._cssomPrefixes = C, f.mq = $, f.hasEvent = L, f.testProp = function (e) {
        return a([e])
    }, f.testAllProps = u, f.testStyles = A, f.prefixed = function (e, t, n) {
        return t ? u(e, t, n) : u(e, "pfx")
    }, m.className = m.className.replace(/(^|\s)no-js(\s|$)/, "$1$2") + (g ? " js " + O.join(" ") : ""), f
    ...
    function p(e, t, n, i, o) {
        for (var r, s, a, l, u, p, h = t.createDocumentFragment(), f = [], g = 0, m = e.length; m > g; g++) if ((r = e[g]) || 0 === r) if ("object" === re.type(r)) re.merge(f, r.nodeType ? [r] : r); else if (Qe.test(r)) {
        ...
        for (h.textContent = "", g = 0; r = f[g++];) if (i && re.inArray(r, i) > -1) o && o.push(r); else if (u = re.contains(r.ownerDocument, r), s = c(h.appendChild(r), "script"), u && d(s), n) for (p = 0; r = s[p++];) $e.test(r.type || "") && n.push(r);
        return h
    }
    ...
    function m(e, t, n, i, o, r) {
        ...
        if (null == i && null == o ? (o = n, i = n = void 0) : null == o && ("string" == typeof n ? (o = i, i = void 0) : (o = i, i = n, n = void 0)), !1 === o) o = f; else if (!o) return e;
    ...
    function x(e, t, n, i) {
        t = K.apply([], t);
        var o, r, s, a, l, u, d = 0, h = e.length, f = h - 1, g = t[0], m = re.isFunction(g);
        ...
        if (h && (o = p(t, e[0].ownerDocument, !1, e, i), r = o.firstChild, 1 === o.childNodes.length && (o = r), r || i)) {
            for (s = re.map(c(o, "script"), v), a = s.length; h > d; d++) l = o, d !== f && (l = re.clone(l, !0, !0), a && re.merge(s, c(l, "script"))), n.call(e[d], l, d);
            if (a) for (u = s[s.length - 1].ownerDocument, re.map(s, b), d = 0; a > d; d++) l = s[d], $e.test(l.type || "") && !Se.access(l, "globalEval") && re.contains(u, l) && (l.src ? re._evalUrl && re._evalUrl(l.src) : re.globalEval(l.textContent.replace(qe, "")))
        }
        return e
    }
    ...
    function C(e) {
        var t = X, n = We[e];
        return n || (n = S(e, t), "none" !== n && n || (Re = (Re || re("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement), t = Re[0].contentDocument, t.write(), t.close(), n = S(e, t), Re.detach()), We[e] = n), n
    }

    function k(e, t, n) {
        var i, o, r, s, a = e.style;
        return n = n || Xe(e), s = n ? n.getPropertyValue(t) || n[t] : void 0, "" !== s && void 0 !== s || re.contains(e.ownerDocument, e) || (s = re.style(e, t)), n && !ie.pixelMarginRight() && Ue.test(s) && Ve.test(t) && (i = a.width, o = a.minWidth, r = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = o, a.maxWidth = r), void 0 !== s ? s + "" : s
    }
    ...
    function Y(e, t, n, i, o) {
        for (var r = n === (i ? "border" : "content") ? 4 : "width" === t ? 1 : 0, s = 0; 4 > r; r += 2) "margin" === n && (s += re.css(e, n + Ye[r], !0, o)), i ? ("content" === n && (s -= re.css(e, "padding" + Ye[r], !0, o)), "margin" !== n && (s -= re.css(e, "border" + Ye[r] + "Width", !0, o))) : (s += re.css(e, "padding" + Ye[r], !0, o), "padding" !== n && (s += re.css(e, "border" + Ye[r] + "Width", !0, o)));
        return s
    }

    function O(e, t, n) {
        var i = !0, o = "width" === t ? e.offsetWidth : e.offsetHeight, r = Xe(e),
    ...
    function E(e, t) {
        for (var n, i, o, r = [], s = 0, a = e.length; a > s; s++) i = e[s], i.style && (r[s] = Se.get(i, "olddisplay"), n = i.style.display, t ? (r[s] || "none" !== n || (i.style.display = ""), "" === i.style.display && Oe(i) && (r[s] = Se.access(i, "olddisplay", C(i.nodeName)))) : (o = Oe(i), "none" === n && o || Se.set(i, "olddisplay", o ? n : re.css(i, "display"))));
    ...
    function D(e, t, n) {
        var i, o, r, s, a, l, u, c = this, d = {}, p = e.style, h = e.nodeType && Oe(e), f = Se.get(e, "fxshow");
        ...
        })), 1 === e.nodeType && ("height" in t || "width" in t) && (n.overflow = [p.overflow, p.overflowX, p.overflowY], u = re.css(e, "display"), "inline" === ("none" === u ? Se.get(e, "olddisplay") || C(e.nodeName) : u) && "none" === re.css(e, "float") && (p.display = "inline-block")), n.overflow && (p.overflow = "hidden", c.always(function () {
        ...
        if (re.isEmptyObject(d)) "inline" === ("none" === u ? C(e.nodeName) : u) && (p.display = u); else {
            f ? "hidden" in f && (h = f.hidden) : f = Se.access(e, "fxshow", {}), r && (f.hidden = !h), h ? re(e).show() : c.done(function () {
                re(e).hide()
            }), c.done(function () {
                var t;
                Se.remove(e, "fxshow");
            ...
            for (i in d) s = Q(h ? f[i] : 0, i, c), i in f || (f[i] = s.start, h && (s.end = s.start, s.start = "width" === i || "height" === i ? 1 : 0))
        }
    }
    ...
    function z(e, t, n) {
        var i, o, r = 0, s = z.prefilters.length, a = re.Deferred().always(function () {
            delete l.elem
        }), l = function () {
            if (o) return !1;
        ...
        for (M(c, u.opts.specialEasing); s > r; r++) if (i = z.prefilters[r].call(u, e, c, u.opts)) return re.isFunction(i.stop) && (re._queueHooks(u.elem, u.opts.queue).stop = re.proxy(i.stop, i)), i;
    ...
    function W(e, t, n, i) {
        ...
        }); else if (n || "object" !== re.type(t)) i(e, t); else for (o in t) W(e + "[" + o + "]", t[o], n, i)
    }
    ...
    var U = [], X = e.document, G = U.slice, K = U.concat, Z = U.push, J = U.indexOf, ee = {}, te = ee.toString,
    ...
    var ce = function (e) {
        function t(e, t, n, i) {
            var o, r, s, a, l, u, d, h, f = t && t.ownerDocument, g = t ? t.nodeType : 9;
            ...
            if (!i && ((t ? t.ownerDocument || t : F) !== E && O(t), t = t || E, $)) {
                if (11 !== g && (u = ye.exec(e))) if (o = u[1]) {
                    ...
                    if ((o = u[3]) && T.getElementsByClassName && t.getElementsByClassName) return Z.apply(n, t.getElementsByClassName(o)), n
                }
                if (T.qsa && !R[e + " "] && (!L || !L.test(e))) {
                    if (1 !== g) f = t, h = e; else if ("object" !== t.nodeName.toLowerCase()) {
                        ...
                        h = d.join(","), f = ve.test(e) && c(t.parentNode) || t
                    }
                    if (h) try {
        ...
        function h(e, t, n) {
            var i = t.dir, o = n && "parentNode" === i, r = N++;
        ...
        function y(e, t, n, o, r, s) {
            return o && !o[z] && (o = y(o)), r && !r[z] && (r = y(r, s)), i(function (i, s, a, l) {
                var u, c, d, p = [], h = [], f = s.length, y = i || g(t || "*", a.nodeType ? [a] : a, []),
                    v = !e || !i && t ? y : m(y, p, e, a, l), b = n ? r || (i ? e : f || o) ? [] : s : v;
        ...
        function v(e) {
            for (var t, n, i, o = e.length, r = x.relative[e[0].type], s = r || x.relative[" "], a = r ? 1 : 0, l = h(function (e) {
                ...
                return t = null, o
            }]; o > a; a++) if (n = x.relative[e[a].type]) c = [h(f(c), n)]; else {
                if (n = x.filter[e[a].type].apply(null, e[a].matches), n[z]) {
                    for (i = ++a; o > i && !x.relative[e[i].type]; i++) ;
                    return y(a > 1 && f(c), a > 1 && p(e.slice(0, a - 1).concat({value: " " === e[a - 2].type ? "*" : ""})).replace(ae, "$1"), n, i > a && v(e.slice(a, i)), o > i && v(e = e.slice(i)), o > i && p(e))
                }
                c.push(n)
            }
            return f(c)
        ...
        function b(e, n) {
            var o = n.length > 0, r = e.length > 0, s = function (i, s, a, l, u) {
                var c, d, p, h = 0, f = "0", g = i && [], y = [], v = _, b = i || r && x.find.TAG("*", u),
                    w = H += null == v ? 1 : Math.random() || .1, T = b.length;
                ...
                if (h += f, o && f !== h) {
                    ...
                    Z.apply(l, y), u && !i && y.length > 0 && h + n.length > 1 && t.uniqueSort(l)
                }
                return u && (H = w, _ = v), g
            };
            return o ? i(s) : s
        ...
        var w, T, x, P, S, C, k, j, _, I, Y, O, E, A, $, L, Q, D, M, z = "sizzle" + 1 * new Date, F = e.document, H = 0,
            N = 0, B = n(), q = n(), R = n(), W = function (e, t) {
                return e === t && (Y = !0), 0
            }, V = 1 << 31, U = {}.hasOwnProperty, X = [], G = X.pop, K = X.push, Z = X.push, J = X.slice,
            ee = function (e, t) {
        ...
        T = t.support = {}, S = t.isXML = function (e) {
            ...
            return i !== E && 9 === i.nodeType && i.documentElement ? (E = i, A = E.documentElement, $ = !S(E), (n = E.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", xe, !1) : n.attachEvent && n.attachEvent("onunload", xe)), T.attributes = o(function (e) {
                ...
                return A.appendChild(e).id = z, !E.getElementsByName || !E.getElementsByName(z).length
                ...
                T.disconnectedMatch = D.call(e, "div"), D.call(e, "[s!='']:x"), Q.push("!=", re)
            }), L = L.length && new RegExp(L.join("|")), Q = Q.length && new RegExp(Q.join("|")), t = me.test(A.compareDocumentPosition), M = t || me.test(A.contains) ? function (e, t) {
            ...
            return (e.ownerDocument || e) !== E && O(e), M(e, t)
        }, t.attr = function (e, t) {
            ...
            filter: {
                TAG: function (e) {
                    ...
                    return 1 === i && 0 === o ? function (e) {
                        ...
                        var u, c, d, p, h, f, g = r !== s ? "nextSibling" : "previousSibling", m = t.parentNode,
                        ...
                        if (m) {
                            ...
                            } else if (v && (p = t, d = p[z] || (p[z] = {}), c = d[p.uniqueID] || (d[p.uniqueID] = {}), u = c[e] || [], h = u[0] === H && u[1], b = h), !1 === b) for (; (p = ++h && p && p[g] || (b = h = 0) || f.pop()) && ((a ? p.nodeName.toLowerCase() !== y : 1 !== p.nodeType) || !++b || (v && (d = p[z] || (p[z] = {}), c = d[p.uniqueID] || (d[p.uniqueID] = {}), c[e] = [H, b]), p !== t));) ;
        ...
        return d.prototype = x.filters = x.pseudos, x.setFilters = new d, C = t.tokenize = function (e, n) {
            ...
            var n, i = [], o = [], r = R[e + " "];
            if (!r) {
                for (t || (t = C(e)), n = t.length; n--;) r = v(t[n]), r[z] ? i.push(r) : o.push(r);
                r = R(e, b(o, i)), r.selector = e
            }
            return r
        }, j = t.select = function (e, t, n, i) {
            var o, r, s, a, l, u = "function" == typeof e && e, d = !i && C(e = u.selector || e);
            if (n = n || [], 1 === d.length) {
            ...
            return (u || k(e, d))(i, t, !$, n, !t || ve.test(e) && c(t.parentNode) || t), n
        }, T.sortStable = z.split("").sort(W).join("") === z, T.detectDuplicates = !!Y, O(), T.sortDetached = o(function (e) {
    ...
    re.fn.extend({
        ...
        re.fn[e] = function (n, i) {
            ...
            return "Until" !== e.slice(-5) && (i = n), i && "string" == typeof i && (o = re.filter(i, o)), this.length > 1 && (be[e] || re.uniqueSort(o), ve.test(e) && o.reverse()), this.pushStack(o)
        }
    });
    var we = /\S+/g;
    re.Callbacks = function (e) {
        ...
        Deferred: function (e) {
            ...
            var t, n, i, o = 0, r = G.call(arguments), s = r.length,
    ...
    re.fn.ready = function (e) {
        ...
        return Te || (Te = re.Deferred(), "complete" === X.readyState || "loading" !== X.readyState && !X.documentElement.doScroll ? e.setTimeout(re.ready) : (X.addEventListener("DOMContentLoaded", s), e.addEventListener("load", s))), Te.promise(t)
    }, re.ready.promise();
    ...
    var Se = new a, Ce = new a, ke = /^(?:\{[\w\W]*\}|\[[\w\W]*\])$/, je = /[A-Z]/g;
    re.extend({
        hasData: function (e) {
    ...
    var _e = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, Ie = new RegExp("^(?:([+-])=|)(" + _e + ")([a-z%]*)$", "i"),
        Ye = ["Top", "Right", "Bottom", "Left"], Oe = function (e, t) {
            return e = t || e, "none" === re.css(e, "display") || !re.contains(e.ownerDocument, e)
        }, Ee = /^(?:checkbox|radio)$/i, Ae = /<([\w:-]+)/, $e = /^$|\/(?:java|ecma)script/i, Le = {
    ...
    var De = /^key/, Me = /^(?:mouse|pointer|contextmenu|drag|drop)|click/, ze = /^([^.]*)(?:\.(.+)|)/;
    re.event = {
        global: {},
        add: function (e, t, n, i, o) {
            ...
            }), t = (t || "").match(we) || [""], u = t.length; u--;) a = ze.exec(t[u]) || [], h = g = a[1], f = (a[2] || "").split(".").sort(), h && (d = re.event.special[h] || {}, h = (o ? d.delegateType : d.bindType) || h, d = re.event.special[h] || {}, c = re.extend({
                type: h,
                origType: g,
                data: i,
                handler: n,
        ...
        remove: function (e, t, n, i, o) {
            ...
            if (m && (l = m.events)) {
                for (t = (t || "").match(we) || [""], u = t.length; u--;) if (a = ze.exec(t[u]) || [], h = g = a[1], f = (a[2] || "").split(".").sort(), h) {
                    for (d = re.event.special[h] || {}, h = (i ? d.delegateType : d.bindType) || h, p = l[h] || [], a = a[2] && new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = r = p.length; r--;) c = p[r], !o && g !== c.origType || n && n.guid !== c.guid || a && !a.test(c.namespace) || i && i !== c.selector && ("**" !== i || !c.selector) || (p.splice(r, 1), c.selector && p.delegateCount--, d.remove && d.remove.call(e, c));
        ...
        dispatch: function (e) {
            e = re.event.fix(e);
            var t, n, i, o, r, s = [], a = G.call(arguments), l = (Se.get(this, "events") || {})[e.type] || [],
        ...
        mouseHooks: {
            ...
            filter: function (e, t) {
                ...
                return null == e.pageX && null != t.clientX && (n = e.target.ownerDocument || X, i = n.documentElement, o = n.body, e.pageX = t.clientX + (i && i.scrollLeft || o && o.scrollLeft || 0) - (i && i.clientLeft || o && o.clientLeft || 0), e.pageY = t.clientY + (i && i.scrollTop || o && o.scrollTop || 0) - (i && i.clientTop || o && o.clientTop || 0)), e.which || void 0 === r || (e.which = 1 & r ? 1 : 2 & r ? 3 : 4 & r ? 2 : 0), e
            }
        },
        fix: function (e) {
            if (e[re.expando]) return e;
            var t, n, i, o = e.type, r = e, s = this.fixHooks[o];
            for (s || (this.fixHooks[o] = s = Me.test(o) ? this.mouseHooks : De.test(o) ? this.keyHooks : {}), i = s.props ? this.props.concat(s.props) : this.props, e = new re.Event(r), t = i.length; t--;) n = i[t], e[n] = r[n];
    ...
    var Fe = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:-]+)[^>]*)\/>/gi, He = /<script|<style|<link/i,
        Ne = /checked\s*(?:[^=]|=\s*.checked.)/i, Be = /^true\/(.*)/, qe = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g;
    re.extend({
        htmlPrefilter: function (e) {
            ...
            if (t) if (n) for (r = r || c(e), s = s || c(a), i = 0, o = r.length; o > i; i++) w(r[i], s[i]); else w(e, a);
    ...
    var Re, We = {HTML: "block", BODY: "block"}, Ve = /^margin/, Ue = new RegExp("^(" + _e + ")(?!px)[a-z%]+$", "i"),
        Xe = function (t) {
    ...
    !function () {
        ...
        var n, i, o, r, s = X.createElement("div"), a = X.createElement("div");
    ...
    var Ze = /^(none|table(?!-c[ea]).+)/, Je = {position: "absolute", visibility: "hidden", display: "block"},
    ...
    re.extend({
        ...
        style: function (e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                return t = re.cssProps[a] || (re.cssProps[a] = _(a) || a), s = re.cssHooks[t] || re.cssHooks[a], void 0 === n ? s && "get" in s && void 0 !== (o = s.get(e, !1, i)) ? o : l[t] : (r = typeof n, "string" === r && (o = Ie.exec(n)) && o[1] && (n = u(e, t, o), r = "number"), void(null != n && n === n && ("number" === r && (n += o && o[3] || (re.cssNumber[a] ? "" : "px")), ie.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (l[t] = "inherit"), s && "set" in s && void 0 === (n = s.set(e, n, i)) || (l[t] = n))))
            }
        },
        css: function (e, t, n, i) {
            var o, r, s, a = re.camelCase(t);
            return t = re.cssProps[a] || (re.cssProps[a] = _(a) || a), s = re.cssHooks[t] || re.cssHooks[a], s && "get" in s && (o = s.get(e, !0, n)), void 0 === o && (o = k(e, t, i)), "normal" === o && t in et && (o = et[t]), "" === n || n ? (r = parseFloat(o), !0 === n || isFinite(r) ? r || 0 : o) : o
        }
        ...
        re.cssHooks[t] = {
            get: function (e, n, i) {
                ...
                var o, r = i && Xe(e), s = i && Y(e, t, i, "border-box" === re.css(e, "boxSizing", !1, r), r);
                return s && (o = Ie.exec(n)) && "px" !== (o[3] || "px") && (e.style[t] = n, n = re.css(e, t)), I(e, n, s)
            }
        }
        ...
        constructor: A, init: function (e, t, n, i, o, r) {
    ...
    re.Animation = re.extend(z, {
        ...
        }, prefilters: [D], prefilter: function (e, t) {
    ...
    re.fn.extend({
        addClass: function (e) {
            ...
            return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : re.isFunction(e) ? this.each(function (n) {
                ...
                var t, i, o, r;
                if ("string" === n) for (i = 0, o = re(this), r = e.match(we) || []; t = r[i++];) o.hasClass(t) ? o.removeClass(t) : o.addClass(t); else void 0 !== e && "boolean" !== n || (t = F(this), t && Se.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || !1 === e ? "" : Se.get(this, "__className__") || ""))
            })
        }, hasClass: function (e) {
            var t, n, i = 0;
    ...
    re.extend(re.event, {
        trigger: function (t, n, i, o) {
            var r, s, a, l, u, c, d, p = [i || X], h = ne.call(t, "type") ? t.type : t,
            ...
            if (s = a = i = i || X, 3 !== i.nodeType && 8 !== i.nodeType && !ft.test(h + re.event.triggered) && (h.indexOf(".") > -1 && (f = h.split("."), h = f.shift(), f.sort()), u = h.indexOf(":") < 0 && "on" + h, t = t[re.expando] ? t : new re.Event(h, "object" == typeof t && t), t.isTrigger = o ? 2 : 3, t.namespace = f.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = i), n = null == n ? [t] : re.makeArray(n, [t]), d = re.event.special[h] || {}, o || !d.trigger || !1 !== d.trigger.apply(i, n))) {
                if (!o && !d.noBubble && !re.isWindow(i)) {
                    for (l = d.delegateType || h, ft.test(l + h) || (s = s.parentNode); s; s = s.parentNode) p.push(s), a = s;
                    a === (i.ownerDocument || X) && p.push(a.defaultView || a.parentWindow || e)
                }
                for (r = 0; (s = p[r++]) && !t.isPropagationStopped();) t.type = r > 1 ? l : d.bindType || h, c = (Se.get(s, "events") || {})[t.type] && Se.get(s, "handle"), c && c.apply(s, n), (c = u && s[u]) && c.apply && Pe(s) && (t.result = c.apply(s, n), !1 === t.result && t.preventDefault());
                return t.type = h, o || t.isDefaultPrevented() || d._default && !1 !== d._default.apply(p.pop(), n) || !Pe(i) || u && re.isFunction(i[h]) && !re.isWindow(i) && (a = i[u], a && (i[u] = null), re.event.triggered = h, i[h](), re.event.triggered = void 0, a && (i[u] = a)), t.result
            }
    ...
    var vt = /#.*$/, bt = /([?&])_=[^&]*/, wt = /^(.*?):[ \t]*([^\r\n]*)$/gm,
        Tt = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, xt = /^(?:GET|HEAD)$/, Pt = /^\/\//, St = {},
        Ct = {}, kt = "*/".concat("*"), jt = X.createElement("a");
    jt.href = gt.href, re.extend({
        active: 0,
        lastModified: {},
        etag: {},
        ajaxSettings: {
        ...
        ajax: function (t, n) {
            ...
            var o, r, s, a, l, u, c, d, p = re.ajaxSetup({}, n), h = p.context || p,
                f = p.context && (h.nodeType || h.jquery) ? re(h) : re.event, g = re.Deferred(),
                m = re.Callbacks("once memory"), y = p.statusCode || {}, v = {}, b = {}, w = 0, T = "canceled", x = {
            ...
            c = re.event && p.global, c && 0 == re.active++ && re.event.trigger("ajaxStart"), p.type = p.type.toUpperCase(), p.hasContent = !xt.test(p.type), r = p.url, p.hasContent || (p.data && (r = p.url += (yt.test(r) ? "&" : "?") + p.data, delete p.data), !1 === p.cache && (p.url = bt.test(r) ? r.replace(bt, "$1_=" + mt++) : r + (yt.test(r) ? "&" : "?") + "_=" + mt++)), p.ifModified && (re.lastModified[r] && x.setRequestHeader("If-Modified-Since", re.lastModified[r]), re.etag[r] && x.setRequestHeader("If-None-Match", re.etag[r])), (p.data && p.hasContent && !1 !== p.contentType || n.contentType) && x.setRequestHeader("Content-Type", p.contentType), x.setRequestHeader("Accept", p.dataTypes[0] && p.accepts[p.dataTypes[0]] ? p.accepts[p.dataTypes[0]] + ("*" !== p.dataTypes[0] ? ", " + kt + "; q=0.01" : "") : p.accepts["*"]);
    ...
    var At = {0: 200, 1223: 204}, $t = re.ajaxSettings.xhr();
    ie.cors = !!$t && "withCredentials" in $t, ie.ajax = $t = !!$t, re.ajaxTransport(function (t) {
        var n, i;
        return ie.cors || $t && !t.crossDomain ? {
            send: function (o, r) {
                ...
                n = function (e) {
                    return function () {
                        n && (n = i = a.onload = a.onerror = a.onabort = a.onreadystatechange = null, "abort" === e ? a.abort() : "error" === e ? "number" != typeof a.status ? r(0, "error") : r(a.status, a.statusText) : r(At[a.status] || a.status, a.statusText, "text" !== (a.responseType || "text") || "string" != typeof a.responseText ? {binary: a.response} : {text: a.responseText}, a.getAllResponseHeaders()))
                    }
    ...
    var Mt = e.jQuery, zt = e.$;
    return re.noConflict = function (t) {
        return e.$ === re && (e.$ = zt), t && e.jQuery === re && (e.jQuery = Mt), re
    }, t || (e.jQuery = e.$ = re), re
}), function () {
    var e, t, n, i, o, r, s, a, l, u, c, d, p, h, f, g, m, y, v, b, w, T, x, P, S, C, k, j, _, I, Y, O, E, A, $, L, Q,
        D, M, z, F, H, N, B, q, R, W, V, U, X = [].slice, G = {}.hasOwnProperty, K = function (e, t) {
            function n() {
                this.constructor = e
            }
    ...
    for (w = {
        ...
        return t = _(), (n = function () {
            var i;
            return i = _() - t, i >= 33 ? (t = _(), e(i, function () {
                return Y(n)
            })) : setTimeout(n, 33 - i)
        })()
    }, O = function () {
    ...
    }(), u = window.Pace || {}, window.Pace = u, T(u, s.prototype), I = u.options = T({}, w, window.paceOptions, P()), W = ["ajax", "document", "eventLag", "elements"], N = 0, q = W.length; q > N; N++) Q = W[N], !0 === I[Q] && (I[Q] = w[Q]);
    l = function (e) {
        function t() {
    ...
    }(), H = window.XMLHttpRequest, F = window.XDomainRequest, z = window.WebSocket, x = function (e, t) {
        var n, i, o;
        o = [];
        for (n in t.prototype) try {
            i = t.prototype[n], o.push(null == e[n] && "function" != typeof i ? e[n] = i : void 0)
        } catch (e) {
            e
        }
        return o
        ...
        var e, t, n;
        return t = arguments[0], e = 2 <= arguments.length ? X.call(arguments, 1) : [], k.unshift("ignore"), n = t.apply(null, e), k.shift(), n
    }, u.track = function () {
        var e, t, n;
        return t = arguments[0], e = 2 <= arguments.length ? X.call(arguments, 1) : [], k.unshift("track"), n = t.apply(null, e), k.shift(), n
    }, L = function (e) {
        var t;
        ...
        function t() {
            ...
            t.__super__.constructor.apply(this, arguments), e = function (e) {
                ...
                return t = e.open, e.open = function (i, o) {
                    return L(i) && n.trigger("request", {type: i, url: o, request: e}), t.apply(e, arguments)
                }
            }, window.XMLHttpRequest = function (t) {
                var n;
                return n = new H(t), e(n), n
            };
            try {
            ...
            if (null != z && I.ajax.trackWebSockets) {
                window.WebSocket = function (e, t) {
                    var i;
                    return i = null != t ? new z(e, t) : new z(e), L("socket") && n.trigger("request", {
                        type: "socket",
                        url: e,
                        protocols: t,
                        request: i
        ...
        var n, i, o, r, s;
        return r = t.type, o = t.request, s = t.url, $(s) ? void 0 : u.running || !1 === I.restartOnRequestAfter && "force" !== L(r) ? void 0 : (i = arguments, n = I.restartOnRequestAfter || 0, "boolean" == typeof n && (n = 0), setTimeout(function () {
            var t, n, s, a, l;
        ...
        return e.prototype.watch = function (e) {
            var t, n, i, o;
            return i = e.type, t = e.request, o = e.url, $(o) ? void 0 : (n = "socket" === i ? new h(t) : new f(t), this.elements.push(n))
        }, e
    }(), f = function () {
        function e(e) {
            ...
            }, !1), r = ["load", "abort", "timeout", "error"], n = 0, i = r.length; i > n; n++) t = r[n], e.addEventListener(t, function () {
        ...
        function e() {
            ...
            this.progress = 0, e = 0, o = [], i = 0, n = _(), t = setInterval(function () {
                var s;
                return s = _() - n - 50, n = _(), o.push(s), o.length > I.eventLag.sampleCount && o.shift(), e = m(o), ++i >= I.eventLag.minSamples && e < I.eventLag.lagThreshold ? (r.progress = 100, clearInterval(t)) : r.progress = 3 / (e + 3) * 100
            }, 50)
        }
        ...
        function e(e) {
            this.source = e, this.last = this.sinceLastUpdate = 0, this.rate = I.initialRate, this.catchup = 0, this.progress = this.lastProgress = 0, null != this.source && (this.progress = O(this.source, "progress"))
        }

        return e.prototype.tick = function (e, t) {
            var n;
            return null == t && (t = O(this.source, "progress")), t >= 100 && (this.done = !0), t === this.last ? this.sinceLastUpdate += e : (this.sinceLastUpdate && (this.rate = (t - this.last) / this.sinceLastUpdate), this.catchup = (t - this.progress) / I.catchupTime, this.sinceLastUpdate = 0, this.last = t), t > this.progress && (this.progress += this.catchup * e), n = 1 - Math.pow(this.progress / 100, I.easeFactor), this.progress += n * this.rate * e, this.progress = Math.min(this.lastProgress + I.maxProgressPerFrame, this.progress), this.progress = Math.max(0, this.progress), this.progress = Math.min(100, this.progress), this.lastProgress = this.progress, this.progress
        }, e
    }(), D = null, A = null, y = null, M = null, g = null, v = null, u.running = !1, C = function () {
        return I.restartOnPushState ? u.restart() : void 0
    }, null != window.history.pushState && (R = window.history.pushState, window.history.pushState = function () {
        return C(), R.apply(window.history, arguments)
    }), null != window.history.replaceState && (U = window.history.replaceState, window.history.replaceState = function () {
        return C(), U.apply(window.history, arguments)
    }), d = {ajax: e, elements: i, document: n, eventLag: r}, (j = function () {
        var e, n, i, o, r, s, a, l;
        for (u.sources = D = [], s = ["ajax", "elements", "document", "eventLag"], n = 0, o = s.length; o > n; n++) e = s[n], !1 !== I[e] && D.push(new d[e](I[e]));
        for (l = null != (a = I.extraSources) ? a : [], i = 0, r = l.length; r > i; i++) Q = l[i], D.push(new Q(I));
        return u.bar = y = new t, A = [], M = new p
    })(), u.stop = function () {
        return u.trigger("stop"), u.running = !1, y.destroy(), v = !0, null != g && ("function" == typeof b && b(g), g = null), j()
    }, u.restart = function () {
        return u.trigger("restart"), u.stop(), u.start()
    }, u.go = function () {
        var e;
        return u.running = !0, y.render(), e = _(), v = !1, g = E(function (t, n) {
            var i, o, r, s, a, l, c, d, h, f, g, m, b, w, T;
            for (100 - y.progress, o = f = 0, r = !0, l = g = 0, b = D.length; b > g; l = ++g) for (Q = D[l], h = null != A[l] ? A[l] : A[l] = [], a = null != (T = Q.elements) ? T : [Q], c = m = 0, w = a.length; w > m; c = ++m) s = a[c], d = null != h[c] ? h[c] : h[c] = new p(s), r &= d.done, d.done || (o++, f += d.tick(t));
            return i = f / o, y.update(M.tick(t, i)), y.done() || r || v ? (y.update(100), u.trigger("done"), setTimeout(function () {
    ...
    t = function () {
        ...
        var i, o, r, s = this, a = !1, l = s.$slider.width(), u = window.innerWidth || e(window).width();
        ...
        return t = t || !1, !0 === u.animating && !0 === u.options.waitForAnimate || !0 === u.options.fade && u.currentSlide === e || u.slideCount <= u.options.slidesToShow ? void 0 : (!1 === t && u.asNavFor(e), i = e, l = u.getLeft(i), s = u.getLeft(u.currentSlide), u.currentLeft = null === u.swipeLeft ? s : u.swipeLeft, !1 === u.options.infinite && !1 === u.options.centerMode && (0 > e || e > u.getDotCount() * u.options.slidesToScroll) ? void(!1 === u.options.fade && (i = u.currentSlide, !0 !== n ? u.animateSlide(s, function () {
            u.postSlide(i)
    ...
    s.version = "0.7.2", s._groups = [], s._throttle = 80, s._maintainScroll = !1, s._beforeUpdate = null, s._afterUpdate = null, s._rows = o, s._parse = i, s._parseOptions = r, s._apply = function (t, n) {
        var a = r(n), l = e(t), u = [l], c = e(window).scrollTop(), d = e("html").outerHeight(!0),
        ...
        }), s._maintainScroll && e(window).scrollTop(c / d * e("html").outerHeight(!0)), this
    ...
    e.fn.directionalHover = function (t) {
        function n(e, t, n, o, r, s, a, l) {
            var h = 0;
            s / 2 >= o - l && (h ^= u), n - a >= r / 2 && (h ^= c), o - l > s / 2 && (h ^= d), r / 2 > n - a && (h ^= p), i(h, e, t, n - a, o - l, r / 2, s / 2)
        }
        ...
        function a(e, t, n, i) {
            "in" === t ? e.animate({top: n, left: i}, 0, function () {
                e.stop().animate({top: 0, left: 0}, l.speed, l.easing)
            }) : "out" === t && e.animate({top: 0, left: 0}, 0, function () {
                e.stop().animate({top: n, left: i}, l.speed, l.easing)
            })
        }

        var l = e.extend({}, e.fn.directionalHover.defaults, t), u = 1, c = 2, d = 4, p = 8, h = u | p, f = u | c,
            g = d | p, m = d | c;
        return this.css({
            position: "relative",
            overflow: "hidden"
        }), this.find("." + l.overlay).css({position: "absolute", top: "-100%"}), this.each(function () {
            var t = e(this);
            t.hover(function (e) {
    ...
    }, e.fn.directionalHover.defaults = {overlay: "dh-overlay", easing: "swing", speed: 400}
}(jQuery), function () {
    "use strict";
    ...
    t.prototype.add = function (e) {
        ...
        for (var n in t) {
            var i = t[n], o = i.newScroll > i.oldScroll, r = o ? i.forward : i.backward;
            for (var s in this.waypoints[n]) {
                var a = this.waypoints[n][s], l = i.oldScroll < a.triggerPoint, u = i.newScroll >= a.triggerPoint,
                    c = l && u, d = !l && !u;
        ...
        for (var r in e) {
            ...
            for (var a in this.waypoints[r]) {
                var l, u, c, d, p, h = this.waypoints[r][a], f = h.options.offset, g = h.triggerPoint, m = 0,
                    y = null == g;
                h.element !== h.element.window && (m = h.adapter.offset()[s.offsetProp]), "function" == typeof f ? f = f.apply(h) : "string" == typeof f && (f = parseFloat(f), h.options.offset.indexOf("%") > -1 && (f = Math.ceil(s.contextDimension * f / 100))), l = s.contextScroll - s.contextOffset, h.triggerPoint = m + l - f, u = g < s.oldScroll, c = h.triggerPoint >= s.oldScroll, d = u && c, p = !u && !c, !y && d ? (h.queueTrigger(s.backward), i[h.group.id] = h.group) : !y && p ? (h.queueTrigger(s.forward), i[h.group.id] = h.group) : y && s.oldScroll >= h.triggerPoint && (h.queueTrigger(s.forward), i[h.group.id] = h.group)
            }
        }
    ...
    var t = $.extend({showFunction: null, hideFunction: null, showShift: 0, wholeVisible: !1, hideShift: 0}, e);
    return this.each(function (e, n) {
        if ($("#scrollzipPoint").length) return $(this).addClass("scrollzip"), !$.isFunction(t.showFunction) || $(this).hasClass("isShown") || $(window).outerHeight() + $("#scrollzipPoint").offset().top - t.showShift <= $(this).offset().top + (t.wholeVisible ? $(this).outerHeight() : 0) || $("#scrollzipPoint").offset().top + (t.wholeVisible ? $(this).outerHeight() : 0) >= $(this).outerHeight() + $(this).offset().top - t.showShift || ($(this).addClass("isShown"), t.showFunction.call(this)), $.isFunction(t.hideFunction) && $(this).hasClass("isShown") && ($(window).outerHeight() + $("#scrollzipPoint").offset().top - t.hideShift < $(this).offset().top + (t.wholeVisible ? $(this).outerHeight() : 0) || $("#scrollzipPoint").offset().top + (t.wholeVisible ? $(this).outerHeight() : 0) > $(this).outerHeight() + $(this).offset().top - t.hideShift) && ($(this).removeClass("isShown"), t.hideFunction.call(this)), this
    })
}, function (e) {
    "function" == typeof define && define.amd ? define(["jquery"], e) : e("object" == typeof exports ? require("jquery") : window.jQuery || window.Zepto)
}(function (e) {
    var t, n, i, o, r, s, a = "Close", l = "BeforeClose", u = "MarkupParse", c = "Open", d = "Change", p = "mfp",
        h = "." + p, f = "mfp-ready", g = "mfp-removing", m = "mfp-prevent-close", y = function () {
        }, v = !!window.jQuery, b = e(window), w = function (e, n) {
            t.ev.on(p + e + h, n)
        }, T = function (t, n, i, o) {
    ...
    y.prototype = {
        constructor: y, init: function () {
            ...
            x("BeforeOpen"), t.st.showCloseBtn && (t.st.closeBtnInside ? (w(u, function (e, t, n, i) {
            ...
            return t.isIE7 && (y += " mfp-ie7"), y && t._addClassToMFP(y), t.updateItemHTML(), x("BuildControls"), e("html").css(g), t.bgOverlay.add(t.wrap).prependTo(t.st.prependTo || e(document.body)), t._lastFocusedEl = document.activeElement, setTimeout(function () {
            ...
            t.appendContent(s, i), n.preloaded = !0, x(d, n), o = n.type, t.container.prepend(t.contentContainer), x("AfterChange")
        }, appendContent: function (e, n) {
            t.content = e, e ? t.st.showCloseBtn && t.st.closeBtnInside && !0 === t.currTemplate[n] ? t.content.find(".mfp-close").length || t.content.append(P()) : t.content = e : t.content = "", x("BeforeAppend"), t.container.addClass("mfp-" + n + "-holder"), t.contentContainer.append(t.content)
        }, parseEl: function (n) {
            var i, o = t.items[n];
            ...
            return o.type = i || t.st.type || "inline", o.index = n, o.parsed = !0, t.items[n] = o, x("ElementParse", o), t.items[n]
            ...
            if (t.preloader) {
                ...
                x("UpdateStatus", o), e = o.status, i = o.text, t.preloader.html(i), t.preloader.find("a").on("click", function (e) {
            ...
            var o;
            i.data && (n = e.extend(i.data, n)), x(u, [t, n, i]), e.each(n, function (n, i) {
        ...
        if ("string" == typeof n) if ("open" === n) {
            var o, r = v ? i.data("magnificPopup") : i[0].magnificPopup, s = parseInt(arguments[1], 10) || 0;
            r.items ? o = r.items[s] : (o = i, r.delegate && (o = o.find(r.delegate)), o = o.eq(s)), t._openClick({mfpEl: o}, i, r)
        } else t.isOpen && t[n].apply(t, Array.prototype.slice.call(arguments, 1)); else n = e.extend(!0, {}, n), v ? i.data("magnificPopup", n) : i[0].magnificPopup = n, t.addGroup(i, n);
        return i
    };
    var k, j, _, I = "inline", Y = function () {
            ...
            initInline: function () {
                ...
                if (Y(), n.src) {
                    ...
                    if (r.length) {
                        ...
                        s && s.tagName && (j || (k = o.hiddenClass, j = T(k), k = "mfp-" + k), _ = r.after(j).detach().removeClass(k)), t.updateStatus("ready")
    ...
    e.magnificPopup.registerModule(E, {
        options: {
            ...
            initAjax: function () {
                t.types.push(E), O = t.st.ajax.cursor, w(a + "." + E, $), w("BeforeChange." + E, $)
            }, getAjax: function (n) {
                O && e(document.body).addClass(O), t.updateStatus("loading");
                var i = e.extend({
                    url: n.src, success: function (i, o, r) {
                        var s = {data: i, xhr: r};
                        x("ParseAjax", s), t.appendContent(e(s.data), E), n.finished = !0, A(), t._setFocus(), setTimeout(function () {
                            t.wrap.addClass(f)
    ...
    e.magnificPopup.registerModule("image", {
        options: {
            ...
            initImage: function () {
                ...
                t.types.push("image"), w(c + i, function () {
                ...
                if (l.length) {
                    ...
                    u.className = "mfp-img", n.el && n.el.find("img").length && (u.alt = n.el.find("img").attr("alt")), n.img = e(u).on("load.mfploader", r).on("error.mfploader", s), u.src = n.src, l.is("img") && (n.img = n.img.clone()), u = n.img[0], u.naturalWidth > 0 ? n.hasSize = !0 : u.width || (n.hasSize = !1)
                }
                return t._parseMarkup(i, {
                    title: Q(n),
                    img_replaceWith: n.img
                }, n), t.resizeImage(), n.hasSize ? (L && clearInterval(L), n.loadError ? (i.addClass("mfp-loading"), t.updateStatus("error", a.tError.replace("%url%", n.src))) : (i.removeClass("mfp-loading"), t.updateStatus("ready")), i) : (t.updateStatus("loading"), n.loading = !0, n.hasSize || (n.imgHidden = !0, i.addClass("mfp-loading"), t.findImageSize(n)), i)
            }
        }
    });
    var D, M = function () {
        ...
        options: {
            ...
            initZoom: function () {
                ...
                if (n.enabled && t.supportsTransition) {
                    var o, r, s = n.duration, u = function (e) {
    ...
    var z = "iframe", F = "//about:blank", H = function (e) {
        if (t.currTemplate[z]) {
    ...
    e.magnificPopup.registerModule("gallery", {
        options: {
            ...
            initGallery: function () {
                ...
                return t.direction = !0, !(!n || !n.enabled) && (r += " mfp-gallery", w(c + o, function () {
    ...
    t.resize(function () {
        ...
        function s() {
            var r = t.scrollTop();
            u.each(function () {
                var t = e(this), s = t.offset().top, c = a(t);
        ...
        u.each(function () {
            ...
            return e.height()
        }, (arguments.length < 1 || null === i) && (i = "50%"), (arguments.length < 2 || null === o) && (o = .1), (arguments.length < 3 || null === r) && (r = !0), t.bind("scroll", s).resize(s), s()
    }
}(jQuery), function () {
    function e() {
    }
    ...
    i.getListeners = function (e) {
        ...
        for (o in r) if (r.hasOwnProperty(o)) for (i = r[o].length; i--;) n = r[o][i], !0 === n.once && this.removeListener(e, n.listener), n.listener.apply(this, t || []) === this._getOnceReturnValue() && this.removeListener(e, n.listener);
        return this
    ...
    function r(e) {
        var t = [];
        if (o(e)) t = e; else if ("number" == typeof e.length) for (var n = 0, i = e.length; i > n; n++) t.push(e[n]); else t.push(e);
        return t
    }

    function s(e, t, n) {
        if (!(this instanceof s)) return new s(e, t);
        "string" == typeof e && (e = document.querySelectorAll(e)), this.elements = r(e), this.options = i({}, this.options), "function" == typeof t ? n = t : i(this.options, t), n && this.on("always", n), this.getImages(), u && (this.jqDeferred = new u.Deferred);
        var o = this;
        setTimeout(function () {
            o.check()
        })
    ...
    var u = e.jQuery, c = e.console, d = void 0 !== c, p = Object.prototype.toString;
    ...
    function r(t) {
        if (o(), "string" == typeof t && (t = document.querySelector(t)), t && "object" == typeof t && t.nodeType) {
            ...
            for (var c = a.isBorderBox = "border-box" == r.boxSizing, d = 0; d < u; d++) {
                var p = l[d], h = r[p], f = parseFloat(h);
                a[p] = isNaN(f) ? 0 : f
            }
            ...
            var P = e(r.height);
            return !1 !== P && (a.height = P + (T ? 0 : m + w)), a.innerWidth = a.width - (g + b), a.innerHeight = a.height - (m + w), a.outerWidth = a.width + y, a.outerHeight = a.height + v, a
        }
    }
    ...
    return n.htmlInit = function (t, o) {
        n.docReady(function () {
            var r = n.toDashed(o), s = "data-" + r, a = document.querySelectorAll("[" + s + "]"),
                l = document.querySelectorAll(".js-" + r), u = n.makeArray(a).concat(n.makeArray(l)),
                c = s + "-options", d = e.jQuery;
    ...
    c.constructor = i, c._create = function () {
        ...
        var e = getComputedStyle(this.element), t = this.layout._getOption("originLeft"),
            n = this.layout._getOption("originTop"), i = e[t ? "left" : "right"], o = e[n ? "top" : "bottom"],
        ...
        var e = this.layout.size, t = {}, n = this.layout._getOption("originLeft"),
            ...
            s = n ? "right" : "left", a = this.position.x + e[o];
        t[r] = this.getXValue(a), t[s] = "";
        var l = i ? "paddingTop" : "paddingBottom", u = i ? "top" : "bottom", c = i ? "bottom" : "top",
    ...
    var n = t.prototype = Object.create(e.Item.prototype), i = n._create;
    n._create = function () {
    ...
    return n.compatOptions.fitWidth = "isFitWidth", n.prototype._resetLayout = function () {
        ...
        var n = t(e), i = this._getElementOffset(e), o = this._getOption("originLeft"), r = o ? i.left : i.right,
    ...
    "use strict";
    var n = e.create("masonry"), i = n.prototype, o = {_getElementOffset: !0, layout: !0, _getMeasurement: !0};
    ...
    "use strict";
    var t = e.create("fitRows"), n = t.prototype;
    ...
    "use strict";
    var t = e.create("vertical", {horizontalAlignment: 0}), n = t.prototype;
    return n._resetLayout = function () {
        this.y = 0
    }, n._getItemLayoutPosition = function (e) {
        e.getSize();
    ...
    function a(e, t) {
        return function (n, i) {
            for (var o = 0; o < e.length; o++) {
                var r = e[o], s = n.sortData[r], a = i.sortData[r];
                if (s > a || s < a) {
    ...
    var p = function () {
        function e(e) {
            ...
            var n = u(e).split(" "), i = n[0], o = i.match(/^\[(.+)\]$/), r = o && o[1], s = t(r, i),
    ...
    e.fn.fitText = function (t, n) {
        var i = t || 1, o = e.extend({minFontSize: Number.NEGATIVE_INFINITY, maxFontSize: Number.POSITIVE_INFINITY}, n);
        return this.each(function () {
    ...
    function s(e, t, n) {
        e.addClass("animated " + t).css("visibility", "visible").show(), e.one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", function () {
            e.removeClass("animated " + t), n && n()
        })
    }
    ...
    function a(i, o, a) {
        ...
        o.shuffle && (i = r(i)), o.reverse && (i = i.toArray().reverse()), e.each(i, function (i, r) {
            function u() {
                t(o.effect) ? c.css("visibility", "visible") : n(o.effect) && c.css("visibility", "hidden"), !(l -= 1) && a && a()
            }

            var c = e(r), d = o.sync ? o.delay : o.delay * i * o.delayScale;
    ...
    var l = function (i, r) {
        var s = this, l = e(i);
        s.init = function () {
            s.$texts = l.find(r.selector), s.$texts.length || (s.$texts = e('<ul class="texts"><li>' + l.html() + "</li></ul>"), l.html(s.$texts)), s.$texts.hide(), s.$current = e("<span>").html(s.$texts.find(":first-child").html()).prependTo(l), t(r.in.effect) ? s.$current.css("visibility", "hidden") : n(r.out.effect) && s.$current.css("visibility", "visible"), s.setOptions(r), s.timeoutRun = null, setTimeout(function () {
            ...
            var n = e.Event(t + ".tlt");
            return l.trigger(n, s), n
        }, s.in = function (i, r) {
            i = i || 0;
            var u, c = s.$texts.find(":nth-child(" + ((i || 0) + 1) + ")"),
                d = e.extend(!0, {}, s.options, c.length ? o(c[0]) : {});
            c.addClass("current"), s.triggerEvent("inAnimationBegin"), l.attr("data-active", c.data("id")), s.$current.html(c.html()).lettering("words"), "char" == s.options.type && s.$current.find('[class^="word"]').css({
                display: "inline-block",
                ...
                e(this).lettering()
            }), u = s.$current.find('[class^="' + s.options.type + '"]').css("display", "inline-block"), t(d.in.effect) ? u.css("visibility", "hidden") : n(d.in.effect) && u.css("visibility", "visible"), s.currentIndex = i, a(u, d.in, function () {
                s.triggerEvent("inAnimationEnd"), d.in.callback && d.in.callback(), r && r(s)
            })
        }, s.out = function (t) {
            ...
            s.triggerEvent("outAnimationBegin"), a(i, r.out, function () {
                n.removeClass("current"), s.triggerEvent("outAnimationEnd"), l.removeAttr("data-active"), r.out.callback && r.out.callback(), t && t(s)
            })
        }, s.start = function (e) {
            setTimeout(function () {
                s.triggerEvent("start"), function e(t) {
                    s.in(t, function () {
    ...
    e.fn.textillate = function (t, n) {
        return this.each(function () {
            var i = e(this), r = i.data("textillate"),
    ...
    var n = function () {
        var n = {
            ...
            var o, r = n.menuClass;
            t.cssArrows && (r += " " + n.menuArrowClass), o = i ? "addClass" : "removeClass", e[o](r)
        }, a = function (t, i) {
            ...
            n = n || t, n = "pan-y" === n ? "auto" : "pan-y", e.css({"ms-touch-action": n, "touch-action": n})
        }, c = function (e) {
            ...
            var n = e(this), i = d(n), o = n.siblings(t.data.popUpSelector);
            ...
            r && (a = "pointerdown.superfish"), i || (a += " touchend.superfish"), o && (a += " mousedown.superfish"), t.on("focusin.superfish", "li", p).on("focusout.superfish", "li", f).on(a, "a", n, g)
        };
        return {
            hide: function (t) {
                if (this.length) {
                ...
                return this.each(function () {
                    var t, i = e(this), o = i.data("sfOptions");
                ...
                return this.each(function () {
                    ...
                    var o = e.extend({}, e.fn.superfish.defaults, t), r = i.find(o.popUpSelector).parent("li");
                    o.$path = a(i, o), i.data("sfOptions", o), s(i, o, !0), l(r, !0), u(i), m(i, o), r.not("." + n.bcClass).superfish("hide", !0), o.onInit.call(this)
                })
            }
        }
    }();
    ...
    e.prototype.tokenize = function (e) {
        ...
        return l = a.length, l ? 1 === l ? (s = a[0].field, u = c[0], function (e, n) {
        ...
        t = n({}, t);
        var i = t.fields, o = t.sort, s = t.sort_empty;
    ...
    var r = /Mac/.test(navigator.userAgent), s = 65, a = 13, l = 27, u = 37, c = 38, d = 80, p = 39, h = 40, f = 78,
        g = 8, m = 46, y = 16, v = r ? 91 : 17, b = r ? 18 : 17, w = 9, T = 1, x = 2,
    ...
    var I = function (e) {
        ...
        if (s = u ? u.getPropertyValue("direction") : a.currentStyle && a.currentStyle.direction, s = s || n.parents("[dir]:first").attr("dir") || "", e.extend(l, {
            ...
            items: [],
            renderCache: {},
            onSearchChange: null === i.loadThrottle ? l.onSearchChange : Y(l.onSearchChange, i.loadThrottle)
    ...
    return o.mixin(D), n.mixin(D), e.extend(D.prototype, {
        setup: function () {
            ...
            m.attr("autocorrect") && i.attr("autocorrect", m.attr("autocorrect")), m.attr("autocapitalize") && i.attr("autocapitalize", m.attr("autocapitalize")), d.$wrapper = t, d.$control = n, d.$control_input = i, d.$dropdown = o, d.$dropdown_content = s, o.on("mouseenter", "[data-selectable]", function () {
                ...
                e.keyCode === b && (d.isCtrlDown = !1), e.keyCode === y && (d.isShiftDown = !1), e.keyCode === v && (d.isCmdDown = !1)
            ...
            }, m.attr("tabindex", -1).hide().after(d.$wrapper), e.isArray(p.items) && (d.setValue(p.items), delete p.items), P && m.on("invalid" + h, function (e) {
                e.preventDefault(), d.isInvalid = !0, d.refreshState()
            }), d.updateOriginalInput(), d.refreshItems(), d.refreshState(), d.updatePlaceholder(), d.isSetup = !0, m.is(":disabled") && d.disable(), d.on("change", this.onChange), m.data("selectize", d), m.addClass("selectized"), d.trigger("initialize"), !0 === p.preload && d.onSearchChange("")
            ...
            if ("single" !== d.settings.mode) {
                ...
                if ("mousedown" === (i = n && n.type.toLowerCase()) && d.isShiftDown && d.$activeItems.length) {
                    for (c = d.$control.children(".active:last"), s = Array.prototype.indexOf.apply(d.$control[0].childNodes, [c[0]]), a = Array.prototype.indexOf.apply(d.$control[0].childNodes, [t[0]]), s > a && (u = s, s = a, a = u), o = s; o <= a; o++) l = d.$control[0].childNodes[o], -1 === d.$activeItems.indexOf(l) && (e(l).addClass("active"), d.$activeItems.push(l));
                    n.preventDefault()
            ...
            u.$activeOption && u.$activeOption.removeClass("active"), u.$activeOption = null, t = e(t), t.length && (u.$activeOption = t.addClass("active"), !n && S(n) || (o = u.$dropdown_content.height(), r = u.$activeOption.outerHeight(!0), n = u.$dropdown_content.scrollTop() || 0, s = u.$activeOption.offset().top - u.$dropdown_content.offset().top + n, a = s, l = s - o + r, s + r > o + n ? u.$dropdown_content.stop().animate({scrollTop: l}, i ? u.settings.scrollDuration : 0) : s < n && u.$dropdown_content.stop().animate({scrollTop: a}, i ? u.settings.scrollDuration : 0)))
        }, selectAll: function () {
            var e = this;
            ...
            if (t !== r.lastQuery ? (r.lastQuery = t, i = r.sifter.search(t, e.extend(a, {score: o})), r.currentResults = i) : i = e.extend(!0, {}, r.currentResults), s.hideSelected) for (n = i.items.length - 1; n >= 0; n--) -1 !== r.items.indexOf(C(i.items[n].id)) && i.items.splice(n, 1);
            return i
        }, refreshOptions: function (t) {
            var n, o, r, s, a, l, u, c, d, p, h, f, g, m, y, v;
            void 0 === t && (t = !0);
            var b = this, w = e.trim(b.$control_input.val()), T = b.search(w), x = b.$dropdown_content,
                P = b.$activeOption && C(b.$activeOption.attr("data-value"));
            for (s = T.items.length, "number" == typeof b.settings.maxOptions && (s = Math.min(s, b.settings.maxOptions)), a = {}, l = [], n = 0; n < s; n++) for (u = b.options[T.items[n].id], c = b.render("option", u), d = u[b.settings.optgroupField] || "", p = e.isArray(d) ? d : [d], o = 0, r = p && p.length; o < r; o++) d = p[o], b.optgroups.hasOwnProperty(d) || (d = ""), a.hasOwnProperty(d) || (a[d] = [], l.push(d)), a[d].push(c);
            for (this.settings.lockOptgroupOrder && l.sort(function (e, t) {
                return (b.optgroups[e].$order || 0) - (b.optgroups[t].$order || 0)
            }), h = [], n = 0, s = l.length; n < s; n++) d = l[n], b.optgroups.hasOwnProperty(d) && a[d].length ? (f = b.render("optgroup_header", b.optgroups[d]) || "", f += a[d].join(""), h.push(b.render("optgroup", e.extend({}, b.optgroups[d], {html: f})))) : h.push(a[d].join(""));
            ...
            if (t = C(t), r = C(n[c.settings.valueField]), null !== t && c.options.hasOwnProperty(t)) {
                ...
                u = c.options[t].$order, r !== t && (delete c.options[t], -1 !== (s = c.items.indexOf(t)) && c.items.splice(s, 1, r)), n.$order = n.$order || u, c.options[r] = n, a = c.renderCache.item, l = c.renderCache.option, a && (delete a[t], delete a[r]), l && (delete l[t], delete l[r]), -1 !== c.items.indexOf(r) && (i = c.getItem(t), o = e(c.render("item", n)), i.hasClass("active") && o.addClass("active"), i.replaceWith(o)), c.lastQuery = null, c.isOpen && c.refreshOptions(!1)
            }
            ...
            O(this, n ? [] : ["change"], function () {
                var i, o, r, s, a, l = this, u = l.settings.mode;
            ...
            var n, i, o, r = this;
            n = "object" == typeof e ? e : r.getItem(e), e = C(n.attr("data-value")), -1 !== (i = r.items.indexOf(e)) && (n.remove(), n.hasClass("active") && (o = r.$activeItems.indexOf(n[0]), r.$activeItems.splice(o, 1)), r.items.splice(i, 1), r.lastQuery = null, !r.settings.persist && r.userOptions.hasOwnProperty(e) && r.removeOption(e, t), i < r.caretPos && r.setCaret(r.caretPos - 1), r.refreshState(), r.updatePlaceholder(), r.updateOriginalInput({silent: t}), r.positionDropdown(), r.trigger("item_remove", e, n))
            ...
            var t, n, i, o, r = this;
            if (e = e || {}, r.tagType === T) {
                for (i = [], t = 0, n = r.items.length; t < n; t++) o = r.options[r.items[t]][r.settings.labelField] || "", i.push('<option value="' + k(r.items[t]) + '" selected="selected">' + k(o) + "</option>");
            ...
            var n, i, o = "", r = !1, s = this, a = /^[\t \r\n]*<([a-z][a-z0-9\-_]*(?:\:[a-z][a-z0-9\-_]*)?)/i;
            return "option" !== e && "item" !== e || (n = C(t[s.settings.valueField]), r = !!n), r && (S(s.renderCache[e]) || (s.renderCache[e] = {}), s.renderCache[e].hasOwnProperty(n)) ? s.renderCache[e][n] : (o = s.settings.render[e].apply(this, [t, k]), "option" !== e && "option_create" !== e || (o = o.replace(a, "<$1 data-selectable")), "optgroup" === e && (i = t[s.settings.optgroupValueField] || "", o = o.replace(a, '<$1 data-group="' + j(k(i)) + '"')), "option" !== e && "item" !== e || (o = o.replace(a, '<$1 data-value="' + j(k(n || "")) + '"')), r && (s.renderCache[e][n] = o), o)
        ...
        var n = e.fn.selectize.defaults, i = e.extend({}, n, t), o = i.dataAttr, r = i.labelField, s = i.valueField,
            a = i.optgroupField, l = i.optgroupLabelField, u = i.optgroupValueField, c = function (t, n) {
                var a, l, u, c, d = t.attr(o);
                if (d) for (n.options = JSON.parse(d), a = 0, l = n.options.length; a < l; a++) n.items.push(n.options[a][s]); else {
                    var p = e.trim(t.val() || "");
                    if (!i.allowEmptyOption && !p.length) return;
                    for (u = p.split(i.delimiter), a = 0, l = u.length; a < l; a++) c = {}, c[r] = u[a], c[s] = u[a], n.options.push(c);
                    n.items = u
                }
            }, d = function (t, n) {
                var c, d, p, h, f = n.options, g = {}, m = function (e) {
                    var t = o && e.attr(o);
                    ...
                    if (l || i.allowEmptyOption) if (g.hasOwnProperty(l)) {
                        ...
                        var c = m(t) || {};
                        c[r] = c[r] || t.text(), c[s] = c[s] || l, c[a] = c[a] || o, g[l] = c, f.push(c), t.is(":selected") && n.items.push(l)
                    }
                }, v = function (t) {
                    var i, o, r, s, a;
                    for (t = e(t), r = t.attr("label"), r && (s = m(t) || {}, s[l] = r, s[u] = r, n.optgroups.push(s)), a = e("option", t), i = 0, o = a.length; i < o; i++) y(a[i], r)
                };
                for (n.maxItems = t.attr("multiple") ? null : 1, h = t.children(), c = 0, d = h.length; c < d; c++) p = h[c].tagName.toLowerCase(), "optgroup" === p ? v(h[c]) : "option" === p && y(h[c])
            };
        return this.each(function () {
            if (!this.selectize) {
                ...
                "select" === r ? d(o, a) : c(o, a), new D(o, e.extend(!0, {}, n, a, t))
            }
        })
    }, e.fn.selectize.defaults = D.defaults, e.fn.selectize.support = {validity: P}, D.define("drag_drop", function (t) {
        ...
        var i = function () {
            ...
            if (c = e("[data-group]", n.$dropdown_content), (r = c.length) && n.$dropdown_content.width()) {
                ...
                t.equalizeWidth && (u = n.$dropdown_content.innerWidth() - i(), a = Math.round(u / r), c.css({width: a}), r > 1 && (l = u - a * (r - 1), c.eq(r - 1).css({width: l})))
            }
        };
...
!function (jQuery, ytp) {
    jQuery.mbYTPlayer = {
                                ...
                                new YT.Player(playerID, {
                                    ...
                                    events: {
                                        onReady: function (e) {
                                            ...
                                            var t = e.target.getPlaybackQuality(), n = jQuery.Event("YTPQualityChange");
        ...
        getDataFromAPI: function (e) {
            if (e.videoData = jQuery.mbStorage.get("YTPlayer_data_" + e.videoID), jQuery(e).off("YTPData.YTPlayer").on("YTPData.YTPlayer", function () {
                ...
                e.dataReceived = !0, jQuery(e).trigger("YTPChanged"), n(t.items[0].snippet), e.hasData = !0;
        ...
        playlist: function (e, t, n, i) {
            ...
            return r.isPlayList = !0, t && (e = jQuery.shuffle(e)), r.videoID || (r.videos = e, r.videoCounter = 0, r.videoLength = e.length, jQuery(r).data("property", e[0]), jQuery(r).mb_YTPlayer()), "function" == typeof n && jQuery(r).one("YTPChanged", function () {
                ...
                i = void 0 === i || i, jQuery(r).playNext(i)
            }), o
        },
        playNext: function (e) {
            var t = this.get(0);
        ...
        changeMovie: function (e) {
            ...
            n.opt.startAt = 0, n.opt.stopAt = 0, n.opt.mask = !1, n.opt.mute = !0, n.hasData = !1, n.hasChanged = !0, n.player.loopTime = void 0, e && jQuery.extend(n.opt, e), n.videoID = getYTPVideoID(n.opt.videoURL).videoID, "true" == n.opt.loop && (n.opt.loop = 9999), jQuery(n.playerEl).CSSAnimate({opacity: 0}, 200, function () {
                var e = jQuery.Event("YTPChangeMovie");
                e.time = n.currentTime, e.videoId = n.videoID, jQuery(n).trigger(e), jQuery(n).YTPGetPlayer().cueVideoByUrl(encodeURI(jQuery.mbYTPlayer.locationProtocol + "//www.youtube.com/v/" + n.videoID), 1, n.opt.quality), jQuery(n).optimizeDisplay(), jQuery.mbYTPlayer.checkForState(n), jQuery.mbYTPlayer.getDataFromAPI(n)
        ...
        fullscreen: function (real) {
            ...
            function RunPrefixMethod(e, t) {
                for (var n, i, o = ["webkit", "moz", "ms", "o", ""], r = 0; r < o.length && !e[n];) {
                    if (n = t, "" == o[r] && (n = n.substr(0, 1).toLowerCase() + n.substr(1)), n = o[r] + n, "undefined" != (i = typeof e[n])) return o = [o[r]], "function" == i ? e[n]() : e[n];
                    r++
                }
            }
        ...
        enableFilters: function () {
            return this.each(function () {
                var e = this, t = jQuery(e.playerEl), n = "";
        ...
        removeFilter: function (e, t) {
            return this.each(function () {
                var n = this;
                if ("function" == typeof e && (t = e, e = null), e) jQuery(this).YTPApplyFilter(e, 0), "function" == typeof t && t(e); else for (var i in n.filters) jQuery(this).YTPApplyFilter(i, 0), "function" == typeof t && t(i)
            })
        },
        getFilters: function () {
        ...
        manageProgress: function () {
            var e = this.get(0), t = jQuery("#controlBar_" + e.id), n = t.find(".mb_YTPProgress"),
                i = t.find(".mb_YTPLoaded"), o = t.find(".mb_YTPseekbar"), r = n.outerWidth(),
                s = Math.floor(e.player.getCurrentTime()), a = Math.floor(e.player.getDuration()), l = s * r / a,
                u = 100 * e.player.getVideoLoadedFraction();
            return i.css({left: 0, width: u + "%"}), o.css({left: 0, width: l}), {totalTime: a, currentTime: s}
        },
        ...
        formatTime: function (e) {
            var t = Math.floor(e / 60), n = Math.floor(e - 60 * t);
            return (9 >= t ? "0" + t : t) + " : " + (9 >= n ? "0" + n : n)
        }
    }, jQuery.fn.optimizeDisplay = function (e) {
        var t = this.get(0), n = jQuery(t.playerEl), i = {};
        ...
        if (t.opt.optimizeDisplay) {
            var r = {}, s = t.wrapper;
            r.width = s.outerWidth(), r.height = s.outerHeight(), i.width = r.width, i.height = "16/9" == t.opt.ratio ? Math.ceil(r.width * (9 / 16)) : Math.ceil(.75 * r.width), i.width = r.width, i.height = "16/9" == t.opt.ratio ? Math.ceil(r.width * (9 / 16)) : Math.ceil(.75 * r.width), i.marginTop = -(i.height - r.height) / 2, i.marginLeft = 0;
        ...
        } else i.width = "100%", i.height = "100%", i.marginTop = 0, i.marginLeft = 0;
        n.css({width: i.width, height: i.height, marginTop: i.marginTop, marginLeft: i.marginLeft})
    ...
    animate: function (e, t, n, i, o) {
        return this.each(function () {
            ...
            if (s.CSSqueue = null, s.eventType = l.type, 0 !== a.length && e) {
                ...
                h[i] && (i = h[i]), a.off(jQuery.CSS.transitionEnd + "." + s.id);
                var f = jQuery.CSS.getProp(e), g = {};
                jQuery.extend(g, e), g[jQuery.CSS.sfx + "transition-property"] = f, g[jQuery.CSS.sfx + "transition-duration"] = t + "ms", g[jQuery.CSS.sfx + "transition-delay"] = n + "ms", g[jQuery.CSS.sfx + "transition-timing-function"] = i, setTimeout(function () {
                    a.one(jQuery.CSS.transitionEnd + "." + s.id, r), a.css(g)
    ...
    return this.each(function () {
        var t = jQuery(this), n = jQuery.normalizeCss(e);
        t.css(n)
    })
};
...
jQuery.browser.android = /Android/i.test(nAgt), jQuery.browser.blackberry = /BlackBerry|BB|PlayBook/i.test(nAgt), jQuery.browser.ios = /iPhone|iPad|iPod|webOS/i.test(nAgt), jQuery.browser.operaMobile = /Opera Mini/i.test(nAgt), jQuery.browser.windowsMobile = /IEMobile|Windows Phone/i.test(nAgt), jQuery.browser.kindle = /Kindle|Silk/i.test(nAgt), jQuery.browser.mobile = jQuery.browser.android || jQuery.browser.blackberry || jQuery.browser.ios || jQuery.browser.windowsMobile || jQuery.browser.operaMobile || jQuery.browser.kindle, jQuery.isMobile = jQuery.browser.mobile, jQuery.isTablet = jQuery.browser.mobile && jQuery(window).width() > 765, jQuery.isAndroidDefault = jQuery.browser.android && !/chrome/i.test(nAgt), function (e) {
    ...
    e.simpleSlider = {
        ...
        init: function (n) {
            return this.each(function () {
                var i = this, o = e(i);
                o.addClass("simpleSlider"), i.opt = {}, e.extend(i.opt, e.simpleSlider.defaults, n), e.extend(i.opt, o.data());
                var r = "h" == i.opt.orientation ? "horizontal" : "vertical",
                    s = e("<div/>").addClass("level").addClass(r);
                o.prepend(s), i.level = s, o.css({cursor: "default"}), "auto" == i.opt.scale && (i.opt.scale = e(i).outerWidth()), o.updateSliderVal(), i.opt.readonly || (o.on(e.simpleSlider.events.start, function (e) {
                    t && (e = e.changedTouches[0]), i.canSlide = !0, o.updateSliderVal(e), o.css({cursor: "col-resize"}), e.preventDefault(), e.stopPropagation()
                }), e(document).on(e.simpleSlider.events.move, function (n) {
                    t && (n = n.changedTouches[0]), i.canSlide && (e(document).css({cursor: "default"}), o.updateSliderVal(n), n.preventDefault(), n.stopPropagation())
                }).on(e.simpleSlider.events.end, function () {
                    e(document).css({cursor: "auto"}), i.canSlide = !1, o.css({cursor: "auto"})
                }))
            })
        },
        updateSliderVal: function (t) {
            ...
            var i = this, o = i.get(0);
            if (o.opt) {
                o.opt.initialval = "number" == typeof o.opt.initialval ? o.opt.initialval : o.opt.initialval(o);
                var r = e(o).outerWidth(), s = e(o).outerHeight();
                o.x = "object" == typeof t ? t.clientX + document.body.scrollLeft - i.offset().left : "number" == typeof t ? t * r / o.opt.scale : o.opt.initialval * r / o.opt.scale, o.y = "object" == typeof t ? t.clientY + document.body.scrollTop - i.offset().top : "number" == typeof t ? (o.opt.scale - o.opt.initialval - t) * s / o.opt.scale : o.opt.initialval * s / o.opt.scale, o.y = i.outerHeight() - o.y, o.scaleX = o.x * o.opt.scale / r, o.scaleY = o.y * o.opt.scale / s, o.outOfRangeX = o.scaleX > o.opt.scale ? o.scaleX - o.opt.scale : o.scaleX < 0 ? o.scaleX : 0, o.outOfRangeY = o.scaleY > o.opt.scale ? o.scaleY - o.opt.scale : o.scaleY < 0 ? o.scaleY : 0, o.outOfRange = "h" == o.opt.orientation ? o.outOfRangeX : o.outOfRangeY, o.value = void 0 !== t ? "h" == o.opt.orientation ? o.x >= i.outerWidth() ? o.opt.scale : o.x <= 0 ? 0 : o.scaleX : o.y >= i.outerHeight() ? o.opt.scale : o.y <= 0 ? 0 : o.scaleY : "h" == o.opt.orientation ? o.scaleX : o.scaleY, "h" == o.opt.orientation ? o.level.width(n(o.x, r) + "%") : o.level.height(n(o.y, s)), "function" == typeof o.opt.callback && o.opt.callback(o)
            }
        }
    ...
    e.mbCookie = {
        set: function (e, t, n, i) {
            t = JSON.stringify(t), n || (n = 7), i = i ? "; domain=" + i : "";
            var o, r = new Date;
            r.setTime(r.getTime() + 864e5 * n), o = "; expires=" + r.toGMTString(), document.cookie = e + "=" + t + o + "; path=/" + i
        }, get: function (e) {
    ...
    e.cleanData = function (t) {
        ...
        }), r.prototype = e.widget.extend(s, {widgetEventPrefix: o ? s.widgetEventPrefix || t : t}, a, {
            constructor: r,
            namespace: l,
            widgetName: t,
            widgetFullName: u
        ...
        for (var i, o, r = n.call(arguments, 1), s = 0, a = r.length; a > s; s++) for (i in r[s]) o = r[s][i], r[s].hasOwnProperty(i) && void 0 !== o && (t[i] = e.isPlainObject(o) ? e.isPlainObject(t[i]) ? e.widget.extend({}, t[i], o) : e.widget.extend({}, o) : o);
        return t
        ...
        _classes: function (t) {
            function n(n, r) {
                var s, a;
                for (a = 0; n.length > a; a++) s = o.classesElementLookup[n[a]] || e(), s = e(t.add ? e.unique(s.get().concat(t.element.get())) : s.not(t.element).get()), o.classesElementLookup[n[a]] = s, i.push(n[a]), r && t.classes[n[a]] && i.push(t.classes[n[a]])
            }
        ...
        _keydown: function (t) {
            if (!t.altKey && !t.ctrlKey) {
                var n = e.ui.keyCode, i = this.headers.length, o = this.headers.index(t.target), r = !1;
                switch (t.keyCode) {
                    case n.RIGHT:
                    case n.DOWN:
        ...
        _refresh: function () {
            var t, n = this.options, i = n.heightStyle, o = this.element.parent();
            this.active = this._findActive(n.active), this._addClass(this.active, "ui-accordion-header-active", "ui-state-active")._removeClass(this.active, "ui-accordion-header-collapsed"), this._addClass(this.active.next(), "ui-accordion-content-active"), this.active.next().show(), this.headers.attr("role", "tab").each(function () {
                var t = e(this), n = t.uniqueId().attr("id"), i = t.next(), o = i.uniqueId().attr("id");
                ...
                "aria-expanded": "true",
                tabIndex: 0
            }).next().attr({"aria-hidden": "false"}) : this.headers.eq(0).attr("tabIndex", 0), this._createIcons(), this._setupEvents(n.event), "fill" === i ? (t = o.height(), this.element.siblings(":visible").each(function () {
        ...
        _animate: function (e, t, n) {
            var i, o, r, s = this, a = 0, l = e.css("box-sizing"), u = e.length && (!t.length || e.index() < t.index()),
                c = this.options.animate || {}, d = u && c.down || c, p = function () {
                    s._toggleComplete(n)
                };
            return "number" == typeof d && (r = d), "string" == typeof d && (o = d), o = o || d.easing || c.easing, r = r || d.duration || c.duration, t.length ? e.length ? (i = e.show().outerHeight(), t.animate(this.hideProps, {
                ...
                duration: r, easing: o, complete: p, step: function (e, n) {
                    n.now = Math.round(e), "height" !== n.prop ? "content-box" === l && (a += n.now) : "content" !== s.options.heightStyle && (n.now = Math.round(i - t.outerHeight() - a), a = 0)
                }
        ...
        _create: function () {
            ...
            }))).sort()), this.active = !1 !== this.options.active && this.anchors.length ? this._findActive(n.active) : e(), this._refresh(), this.active.length && this.load(n.active)
        },
        ...
        _tabKeydown: function (t) {
            var n = e(e.ui.safeActiveElement(this.document[0])).closest("li"), i = this.tabs.index(n), o = !0;
            if (!this._handlePageNav(t)) {
                ...
                t.preventDefault(), clearTimeout(this.activating), i = this._focusNextTab(i, o), t.ctrlKey || t.metaKey || (n.attr("aria-selected", "false"), this.tabs.eq(i).attr("aria-selected", "true"), this.activating = this._delay(function () {
        ...
        _processTabs: function () {
            var t = this, n = this.tabs, i = this.anchors, o = this.panels;
            this.tablist = this._getList().attr("role", "tablist"), this._addClass(this.tablist, "ui-tabs-nav", "ui-helper-reset ui-helper-clearfix ui-widget-header"), this.tablist.on("mousedown" + this.eventNamespace, "> li", function (t) {
                ...
                var o, r, s, a = e(i).uniqueId().attr("id"), l = e(i).closest("li"), u = l.attr("aria-controls");
                t._isLocal(i) ? (o = i.hash, s = o.substring(1), r = t.element.find(t._sanitizeSelector(o))) : (s = l.attr("aria-controls") || e({}).uniqueId()[0].id, o = "#" + s, r = t.element.find(o), r.length || (r = t._createPanel(s), r.insertAfter(t.panels[n - 1] || t.tablist)), r.attr("aria-live", "polite")), r.length && (t.panels = t.panels.add(r)), u && l.data("ui-tabs-aria-controls", u), l.attr({
                    "aria-controls": s,
                    "aria-labelledby": a
                }), r.attr("aria-labelledby", a)
            }), this.panels.attr("role", "tabpanel"), this._addClass(this.panels, "ui-tabs-panel", "ui-widget-content"), n && (this._off(n.not(this.tabs)), this._off(i.not(this.anchors)), this._off(o.not(this.panels)))
        },
        _getList: function () {
        ...
        _setOptionDisabled: function (t) {
            var n, i, o;
            for (e.isArray(t) && (t.length ? t.length === this.anchors.length && (t = !0) : t = !1), o = 0; i = this.tabs[o]; o++) n = e(i), !0 === t || -1 !== e.inArray(o, t) ? (n.attr("aria-disabled", "true"), this._addClass(n, null, "ui-state-disabled")) : (n.removeAttr("aria-disabled"), this._removeClass(n, null, "ui-state-disabled"));
        ...
        _eventHandler: function (t) {
            var n = this.options, i = this.active, o = e(t.currentTarget), r = o.closest("li"), s = r[0] === i[0],
                a = s && n.collapsible, l = a ? e() : this._getPanelForTab(r),
                u = i.length ? this._getPanelForTab(i) : e(),
                c = {oldTab: i, oldPanel: u, newTab: a ? e() : r, newPanel: l};
        ...
        _toggle: function (t, n) {
            ...
            function o() {
                r._addClass(n.newTab.closest("li"), "ui-tabs-active", "ui-state-active"), s.length && r.options.show ? r._show(s, r.options.show, i) : (s.show(), i())
            }

            var r = this, s = n.newPanel, a = n.oldPanel;
            this.running = !0, a.length && this.options.hide ? this._hide(a, this.options.hide, function () {
                r._removeClass(n.oldTab.closest("li"), "ui-tabs-active", "ui-state-active"), o()
            }) : (this._removeClass(n.oldTab.closest("li"), "ui-tabs-active", "ui-state-active"), a.hide(), o()), a.attr("aria-hidden", "true"), n.oldTab.attr({
                "aria-selected": "false",
                "aria-expanded": "false"
        ...
        load: function (t, n) {
            t = this._getIndex(t);
            var i = this, o = this.tabs.eq(t), r = o.find(".ui-tabs-anchor"), s = this._getPanelForTab(o),
                a = {tab: o, panel: s}, l = function (e, t) {
                    "abort" === t && i.panels.stop(!1, !0), i._removeClass(o, "ui-tabs-loading"), s.removeAttr("aria-busy"), e === i.xhr && delete i.xhr
                };
            this._isLocal(r[0]) || (this.xhr = e.ajax(this._ajaxSettings(r, n, a)), this.xhr && "canceled" !== this.xhr.statusText && (this._addClass(o, "ui-tabs-loading"), s.attr("aria-busy", "true"), this.xhr.done(function (e, t, o) {
                setTimeout(function () {
                    s.html(e), i._trigger("load", n, a), l(o, t)
                }, 1)
            }).fail(function (e, t) {
                setTimeout(function () {
                    l(e, t)
        ...
        _ajaxSettings: function (t, n, i) {
            var o = this;
            return {
                url: t.attr("href").replace(/#.*$/, ""), beforeSend: function (t, r) {
                    return o._trigger("beforeLoad", n, e.extend({jqXHR: t, ajaxSettings: r}, i))
                }
            }
        },
    ...
    function n(e) {
        return function (t) {
            ...
            if (n) for (var o = 0, r = n.length; r > o; ++o) {
                var s = n[o].match(/%(-|!)?([a-zA-Z]{1})(:[^;]+;)?/), l = new RegExp(s[0]), u = s[1] || "",
                    c = s[3] || "", d = null;
                s = s[2], a.hasOwnProperty(s) && (d = a[s], d = Number(e[d])), null !== d && ("!" === u && (d = i(c, d)), "" === u && 10 > d && (d = "0" + d.toString()), t = t.replace(l, d.toString()))
            }
            return t = t.replace(/%%/, "%")
        }
    }
    ...
    var a = {Y: "years", m: "months", w: "weeks", d: "days", D: "totalDays", H: "hours", M: "minutes", S: "seconds"},
        l = function (t, n, i) {
            this.el = t, this.$el = e(t), this.interval = null, this.offset = {}, this.instanceNumber = r.length, r.push(this), this.$el.data("countdown-instance", this.instanceNumber), i && (this.$el.on("update.countdown", i), this.$el.on("stoped.countdown", i), this.$el.on("finish.countdown", i)), this.setFinalDate(n), this.start()
        };
    e.extend(l.prototype, {
        start: function () {
            ...
            i.finalDate = this.finalDate, i.offset = e.extend({}, this.offset), i.strftime = n(this.offset), this.$el.trigger(i)
        }
    ...
    function s() {
        M = google.maps, D || (D = {
            ...
            map: {mapTypeId: M.MapTypeId.ROADMAP, center: [46.578498, 2.457275], zoom: 2},
    ...
    function u(t, n, i, o, r) {
        function s(n, o) {
            n && e.each(n, function (e, n) {
                var s = t, a = n;
                H(n) && (s = n[0], a = n[1]), o(i, e, function (e) {
                    a.apply(s, [r || i, e, l])
                })
            })
        }

        var a = n.td || {}, l = {id: o, data: a.data, tag: a.tag};
        s(a.events, M.event.addListener), s(a.onces, M.event.addListenerOnce)
    }
    ...
    function p(t, n) {
        var i, o, r = ["data", "tag", "id", "events", "onces"], s = {};
    ...
    function g(e) {
        var t, i = [];
        if (!r(e)) if (n(e)) if (o(e.length)) i = e; else for (t in e) i.push(e[t]); else i.push(e);
        return i
    }
    ...
    function b(e, t, n, o, r) {
        var s = !!n && y(o.td, !1, !0),
            a = s ? {latLng: s} : !!o.td.address && (i(o.td.address) ? {address: o.td.address} : o.td.address),
            l = !!a && B.get(a), u = this;
    ...
    function w(t, n, i, o) {
        function r() {
            ...
            return a >= t.length ? void i.apply(n, [o]) : void b(s, function (n) {
                delete n.td, e.extend(t[a], n), r.apply(s, [])
            }, !0, {td: t[a]})
        }
    ...
    function P() {
        return N.geocoder || (N.geocoder = new M.Geocoder), N.geocoder
    }
        ...
        this.get = function (t) {
            if (e.length) {
                ...
                for (i = 0; i < e.length; i++) {
                    for (s = e[i], a = l.length === s.keys.length, o = 0; o < l.length && a; o++) r = l[o], (a = r in s.request) && (a = n(t[r]) && "equals" in t[r] && F(t[r]) ? t[r].equals(s.request[r]) : t[r] === s.request[r]);
    ...
    function k() {
        ...
        function n(e) {
            F(e.setMap) && e.setMap(null), F(e.remove) && e.remove(), F(e.free) && e.free(), e = null
        }

        var i = {}, o = {}, s = this;
        s.add = function (e, t, n, r) {
            var l = e.td || {}, u = a(l.id);
            return i[t] || (i[t] = []), u in o && s.clearById(u), o[u] = {
                obj: n,
                sub: r,
                name: t,
                id: u,
            ...
            var r = !1;
            return e in o && (r = n ? o[e].sub : i ? t(o[e]) : o[e].obj), r
            ...
            if (e in i) u(e); else if (r(e)) for (e in i) u(e);
            return a
        }, s.rm = function (e, t, n) {
            var r, a;
            if (!i[e]) return !1;
            if (t) if (n) for (r = i[e].length - 1; r >= 0 && (a = i[e][r], !t(o[a].tag)); r--) ; else for (r = 0; r < i[e].length && (a = i[e][r], !t(o[a].tag)); r++) ; else r = n ? i[e].length - 1 : 0;
            return r in i[e] && s.clearById(i[e][r], r)
        }, s.clearById = function (e, t) {
            if (e in o) {
                var s, a = o[e].name;
                for (s = 0; r(t) && s < i[a].length; s++) e === i[a][s] && (t = s);
                return n(o[e].obj), o[e].sub && n(o[e].sub), delete o[e], i[a].splice(t, 1), !0
            }
            return !1
            ...
            var r, a, l, u = m(o);
            if (e && e.length) e = g(e); else {
                e = [];
                for (r in i) e.push(r)
            }
            for (a = 0; a < e.length; a++) if (l = e[a], t) s.rm(l, u, !0); else if (n) s.rm(l, u, !1); else for (; s.rm(l, u, !1);) ;
    ...
    function j(t, n, o) {
        ...
        i(o) && (o = r(o)), u.run = function () {
            for (var i, r; i = s();) {
                if (F(t[i])) return a = i, r = e.extend(!0, {}, D[i] || {}, o[i].options || {}), void(i in c.latLng ? o[i].values ? w(o[i].values, t, t[i], {
                    td: o[i],
                    opts: r,
                    session: l
                }) : b(t, t[i], c.latLng[i], {td: o[i], opts: r, session: l}) : i in c.geoloc ? T(t, t[i], {
                    td: o[i],
                    opts: r,
                    session: l
                }) : t[i].apply(t, [{td: o[i], opts: r, session: l}]));
                l[i] = null
            }
            n.apply(t, [o, l])
        }, u.ack = function (e) {
    ...
    function _() {
        return N.ds || (N.ds = new M.DirectionsService), N.ds
    }

    function I() {
        return N.dms || (N.dms = new M.DistanceMatrixService), N.dms
    }

    function Y() {
        return N.mzs || (N.mzs = new M.MaxZoomService), N.mzs
    }

    function O() {
        return N.es || (N.es = new M.ElevationService), N.es
    }
    ...
    function A(t, i, o) {
        function r(e) {
            A[e] || (delete $[e].options.map, A[e] = new D.classes.Marker($[e].options), u(t, {td: $[e]}, A[e], $[e].id))
        }
        ...
        function l(e) {
            n(I[e]) ? (F(I[e].obj.setMap) && I[e].obj.setMap(null), F(I[e].obj.remove) && I[e].obj.remove(), F(I[e].shadow.remove) && I[e].obj.remove(), F(I[e].shadow.setMap) && I[e].shadow.setMap(null), delete I[e].obj, delete I[e].shadow) : A[e] && A[e].setMap(null), delete I[e]
        }

        function c() {
            var e, t, n, i, o, r, s, a, l = Math.cos, u = Math.sin, c = arguments;
            return c[0] instanceof M.LatLng ? (e = c[0].lat(), n = c[0].lng(), c[1] instanceof M.LatLng ? (t = c[1].lat(), i = c[1].lng()) : (t = c[1], i = c[2])) : (e = c[0], n = c[1], c[2] instanceof M.LatLng ? (t = c[2].lat(), i = c[2].lng()) : (t = c[2], i = c[3])), o = Math.PI * e / 180, r = Math.PI * n / 180, s = Math.PI * t / 180, a = Math.PI * i / 180, 6371e3 * Math.acos(Math.min(l(o) * l(s) * l(r) * l(a) + l(o) * u(r) * l(s) * u(a) + u(o) * u(s), 1))
        }

        function d() {
            var e = c(i.getCenter(), i.getBounds().getNorthEast());
            return new M.Circle({center: i.getCenter(), radius: 1.25 * e}).getBounds()
        }
        ...
        function h() {
            clearTimeout(y), y = setTimeout(g, 25)
        }

        function f(e) {
            var t = v.fromLatLngToDivPixel(e), n = v.fromDivPixelToLatLng(new M.Point(t.x + o.radius, t.y - o.radius)),
        ...
        function g() {
            if (!x && !S && C) {
                var t, n, r, s, a, u, c, h, g, m, y, v = !1, T = [], j = {}, _ = i.getZoom(),
                    Y = "maxZoom" in o && _ > o.maxZoom, O = p();
                ...
                for (; ;) {
                    ...
                    for (u = {
                        indexes: [],
                        ref: []
                    }, g = m = 0, r = 0; r < s.length; r++) j[s[r]] = !0, u.indexes.push(T[s[r]]), u.ref.push(T[s[r]]), g += $[T[s[r]]].options.position.lat(), m += $[T[s[r]]].options.position.lng();
                    g /= s.length, m /= s.length, u.latLng = new M.LatLng(g, m), u.ref = u.ref.join("-"), u.ref in O ? delete O[u.ref] : (1 === s.length && (I[u.ref] = !0), w(u))
                }
                e.each(O, function (e) {
                    l(e)
                }), S = !1
        ...
        var y, v, b, w, T, x = !1, P = !1, S = !1, C = !1, k = !0, j = this, _ = [], I = {}, Y = {}, O = {}, A = [],
            $ = [], L = [], Q = E(i, o.radius);
        s(), j.getById = function (e) {
            return e in Y && (r(Y[e]), A[Y[e]])
        }, j.rm = function (e) {
            var t = Y[e];
            A[t] && A[t].setMap(null), delete A[t], A[t] = !1, delete $[t], $[t] = !1, delete L[t], L[t] = !1, delete Y[e], delete O[t], P = !0
        }, j.clearById = function (e) {
            return e in Y ? (j.rm(e), !0) : void 0
        }, j.clear = function (e, t, n) {
            var i, o, r, s, a, l = [], u = m(n);
            for (e ? (i = $.length - 1, o = -1, r = -1) : (i = 0, o = $.length, r = 1), s = i; s !== o && (!$[s] || u && !u($[s].tag) || (l.push(O[s]), !t && !e)); s += r) ;
            for (a = 0; a < l.length; a++) j.rm(l[a])
        }, j.add = function (e, t) {
            e.id = a(e.id), j.clearById(e.id), Y[e.id] = A.length, O[A.length] = e.id, A.push(null), $.push(e), L.push(t), P = !0
        }, j.addMarker = function (e, n) {
            n = n || {}, n.id = a(n.id), j.clearById(n.id), n.options || (n.options = {}), n.options.position = e.getPosition(), u(t, {td: n}, e, n.id), Y[n.id] = A.length, O[A.length] = n.id, A.push(e), $.push(n), L.push(n.data || {}), P = !0
        }, j.td = function (e) {
            return $[e]
        }, j.value = function (e) {
            return L[e]
    ...
    function $(e, t) {
        ...
        n.id = function () {
            ...
            i || t.beginUpdate(), t.addMarker(e, n), i || t.endUpdate()
        }, n.getById = function (e) {
            return t.getById(e)
        }, n.clearById = function (e, n) {
            var i;
            return n || t.beginUpdate(), i = t.clearById(e), n || t.endUpdate(), i
        }, n.clear = function (e, n, i, o) {
            o || t.beginUpdate(), t.clear(e, n, i), o || t.endUpdate()
        }
    }

    function L(t, n, i, o) {
        var r = this, s = [];
        D.classes.OverlayView.call(r), r.setMap(t), r.onAdd = function () {
            var t = r.getPanes();
            n.pane in t && e(t[n.pane]).append(o), e.each("dblclick click mouseover mousemove mouseout mouseup mousedown".split(" "), function (t, n) {
                s.push(M.event.addDomListener(o[0], n, function (t) {
                    e.Event(t).stopPropagation(), M.event.trigger(r, n, [t]), r.draw()
                }))
            }), s.push(M.event.addDomListener(o[0], "contextmenu", function (t) {
                e.Event(t).stopPropagation(), M.event.trigger(r, "rightclick", [t]), r.draw()
            }))
    ...
    function Q(o) {
        ...
        function b(n) {
            ...
            return c.sort(function (e, t) {
                ...
                p ? (g = p.offset || [-p.width / 2, -p.height / 2], h = e.extend({}, a), h.options = e.extend({
                    ...
                    offset: {x: ("x" in g ? g.x : g[0]) || 0, y: ("y" in g ? g.y : g[1]) || 0}
                }, a.options || {}), f = x.overlay({
                    td: h,
                    opts: h.options,
                    latLng: y(r)
                }, !0), h.options.pane = "floatShadow", h.options.content = e(document.createElement("div")).width(p.width + "px").height(p.height + "px").css({cursor: "pointer"}), m = x.overlay({
                    td: h,
                    opts: h.options,
                    latLng: y(r)
                }, !0), a.data = {latLng: y(r), markers: []}, e.each(r.indexes, function (e, t) {
                    a.data.markers.push(s.value(t)), s.markerIsSet(t) && s.marker(t).setMap(null)
                }), u(o, {td: a}, m, t, {main: f, shadow: m}), s.store(r, f, m)) : e.each(r.indexes, function (e, t) {
                    s.marker(t).setMap(E)
                })
            }), s
        }
        ...
        function w(t, n, i) {
            var r = [], s = "values" in t.td;
            return s || (t.td.values = [{options: t.opts}]), t.td.values.length ? (m(), e.each(t.td.values, function (e, s) {
                var a, l, c, d, h = p(t, s);
                if (h.options[i]) if (h.options[i][0][0] && H(h.options[i][0][0])) for (l = 0; l < h.options[i].length; l++) for (c = 0; c < h.options[i][l].length; c++) h.options[i][l][c] = y(h.options[i][l][c]); else for (l = 0; l < h.options[i].length; l++) h.options[i][l] = y(h.options[i][l]);
                h.options.map = E, d = new M[n](h.options), r.push(d), a = S.add({td: h}, n.toLowerCase(), d), u(o, {td: h}, d, a)
            }), void f(t, s ? r : r[0])) : void f(t, !1)
        }

        var T, x = this, P = new C, S = new k, E = null;
        x._plan = function (e) {
            var t;
            for (t = 0; t < e.length; t++) P.add(new j(x, c, e[t]));
            s()
        }, x.map = function (e) {
            m(e.latLng, e), u(o, e, E), f(e, E)
        }, x.destroy = function (e) {
            S.clear(), o.empty(), E && (E = null), f(e, !0)
        }, x.overlay = function (t, n) {
            var i = [], r = "values" in t.td;
            return r || (t.td.values = [{
                ...
                var a, l, c = p(t, s),
                    d = e(document.createElement("div")).css({border: "none", borderWidth: 0, position: "absolute"});
                d.append(c.options.content), l = new L(E, c.options, y(c) || y(s), d), i.push(l), d = null, n || (a = S.add(t, "overlay", l), u(o, {td: c}, l, a))
            }), n ? i[0] : void f(t, r ? i : i[0])) : void f(t, !1)
        }, x.marker = function (t) {
            var n, i, r, s = "values" in t.td, l = !E;
            return s || (t.opts.position = t.latLng || y(t.opts.position), t.td.values = [{options: t.opts}]), t.td.values.length ? (l && m(), t.td.cluster && !E.getBounds() ? void M.event.addListenerOnce(E, "bounds_changed", function () {
                x.marker.apply(x, [t])
                ...
                var i = p(t, n);
                i.options.position = y(i.options.position ? i.options.position : n), i.options.position && (i.options.map = E, l && (E.setCenter(i.options.position), l = !1), r.add(i, n))
            }), r.endUpdate(), f(t, i)) : (n = [], e.each(t.td.values, function (e, i) {
                var r, s, a = p(t, i);
                a.options.position = y(a.options.position ? a.options.position : i), a.options.position && (a.options.map = E, l && (E.setCenter(a.options.position), l = !1), s = new D.classes.Marker(a.options), n.push(s), r = S.add({td: a}, "marker", s), u(o, {td: a}, s, r))
            }), f(t, s ? n : n[0])))) : void f(t, !1)
        }, x.getroute = function (e) {
            e.opts.origin = y(e.opts.origin, !0), e.opts.destination = y(e.opts.destination, !0), _().route(e.opts, function (t, n) {
                d(e, n === M.DirectionsStatus.OK && t, n), T.ack()
            })
            ...
            I().getDistanceMatrix(e.opts, function (t, n) {
                d(e, n === M.DistanceMatrixStatus.OK && t, n), T.ack()
            })
        }, x.infowindow = function (n) {
            var i = [], s = "values" in n.td;
            s || (n.latLng && (n.opts.position = n.latLng), n.td.values = [{options: n.opts}]), e.each(n.td.values, function (e, a) {
                var l, c, d = p(n, a);
                d.options.position = y(d.options.position ? d.options.position : a.latLng), E || m(d.options.position), c = new D.classes.InfoWindow(d.options), c && (r(d.open) || d.open) && (s ? c.open(E, d.anchor || t) : c.open(E, d.anchor || (n.latLng ? t : n.session.marker ? n.session.marker : t))), i.push(c), l = S.add({td: d}, "infowindow", c), u(o, {td: d}, c, l)
            }), f(n, s ? i : i[0])
        }, x.circle = function (t) {
            var n = [], i = "values" in t.td;
            return i || (t.opts.center = t.latLng || y(t.opts.center), t.td.values = [{options: t.opts}]), t.td.values.length ? (e.each(t.td.values, function (e, i) {
                var r, s, a = p(t, i);
                a.options.center = y(a.options.center ? a.options.center : i), E || m(a.options.center), a.options.map = E, s = new D.classes.Circle(a.options), n.push(s), r = S.add({td: a}, "circle", s), u(o, {td: a}, s, r)
            }), void f(t, i ? n : n[0])) : void f(t, !1)
        }, x.getaddress = function (e) {
            d(e, e.results, e.status), T.ack()
        }, x.getlatlng = function (e) {
            d(e, e.results, e.status), T.ack()
        }, x.getmaxzoom = function (e) {
            Y().getMaxZoomAtLatLng(e.latLng, function (t) {
                d(e, t.status === M.MaxZoomStatus.OK && t.zoom, status), T.ack()
            })
        }, x.getelevation = function (e) {
            var t, n = [], i = function (t, n) {
                d(e, n === M.ElevationStatus.OK && t, n), T.ack()
            };
            if (e.latLng) n.push(e.latLng); else for (n = g(e.td.locations || []), t = 0; t < n.length; t++) n[t] = y(n[t]);
            if (n.length) O().getElevationForLocations({locations: n}, i); else {
                if (e.td.path && e.td.path.length) for (t = 0; t < e.td.path.length; t++) n.push(y(e.td.path[t]));
                n.length ? O().getElevationAlongPath({path: n, samples: e.td.samples}, i) : T.ack()
            }
            ...
            var n = [], i = "values" in t.td;
            return i || (t.td.values = [{options: t.opts}]), t.td.values.length ? (e.each(t.td.values, function (e, i) {
                var r, s, a = p(t, i);
                a.options.bounds = v(a.options.bounds ? a.options.bounds : i), E || m(a.options.bounds.getCenter()), a.options.map = E, s = new D.classes.Rectangle(a.options), n.push(s), r = S.add({td: a}, "rectangle", s), u(o, {td: a}, s, r)
            }), void f(t, i ? n : n[0])) : void f(t, !1)
            ...
            t || (t = new D.classes.TrafficLayer, t.setMap(E), S.add(e, "trafficlayer", t)), f(e, t)
        }, x.transitlayer = function (e) {
            m();
            var t = S.get("transitlayer");
            t || (t = new D.classes.TransitLayer, t.setMap(E), S.add(e, "transitlayer", t)), f(e, t)
        }, x.bicyclinglayer = function (e) {
            m();
            var t = S.get("bicyclinglayer");
            t || (t = new D.classes.BicyclingLayer, t.setMap(E), S.add(e, "bicyclinglayer", t)), f(e, t)
        }, x.groundoverlay = function (e) {
            e.opts.bounds = v(e.opts.bounds), e.opts.bounds && m(e.opts.bounds.getCenter());
            var t, n = new D.classes.GroundOverlay(e.opts.url, e.opts.bounds, e.opts.opts);
            n.setMap(E), t = S.add(e, "groundoverlay", n), f(e, n, t)
        }, x.streetviewpanorama = function (t) {
            t.opts.opts || (t.opts.opts = {}), t.latLng ? t.opts.opts.position = t.latLng : t.opts.opts.position && (t.opts.opts.position = y(t.opts.opts.position)), t.td.divId ? t.opts.container = document.getElementById(t.td.divId) : t.opts.container && (t.opts.container = e(t.opts.container).get(0));
            var n, i = new D.classes.StreetViewPanorama(t.opts.container, t.opts.opts);
            i && E.setStreetView(i), n = S.add(t, "streetviewpanorama", i), f(t, i, n)
        }, x.kmllayer = function (t) {
            var n = [], i = "values" in t.td;
            return i || (t.td.values = [{options: t.opts}]), t.td.values.length ? (e.each(t.td.values, function (e, i) {
                var r, s, a, c = p(t, i);
                E || m(), a = c.options, c.options.opts && (a = c.options.opts, c.options.url && (a.url = c.options.url)), a.map = E, s = l("3.10") ? new D.classes.KmlLayer(a) : new D.classes.KmlLayer(a.url, a), n.push(s), r = S.add({td: c}, "kmllayer", s), u(o, {td: c}, s, r)
            }), void f(t, i ? n : n[0])) : void f(t, !1)
        }, x.panel = function (t) {
            m();
            var n, i, s = 0, a = 0, l = e(document.createElement("div"));
            l.css({
                position: "absolute",
                zIndex: 1e3,
                visibility: "hidden"
                ...
                left: s,
                visibility: "visible"
            })), n = S.add(t, "panel", l), f(t, l, n), l = null
        }, x.directionsrenderer = function (t) {
            t.opts.map = E;
            var n, i = new M.DirectionsRenderer(t.opts);
            t.td.divId ? i.setPanel(document.getElementById(t.td.divId)) : t.td.container && i.setPanel(e(t.td.container).get(0)), n = S.add(t, "directionsrenderer", i), f(t, i, n)
        }, x.getgeoloc = function (e) {
            f(e, e.latLng)
        }, x.styledmaptype = function (e) {
            m();
            var t = new D.classes.StyledMapType(e.td.styles, e.opts);
            E.mapTypes.set(e.td.id, t), f(e, t)
            ...
            }) : (S.clear(g(t.td.name), t.td.last, t.td.first, t.td.tag), S.objClear(g(t.td.name), t.td.last, t.td.first, t.td.tag)), f(t, !0)
        }, x.get = function (n, o, r) {
            var s, a, l = o ? n : n.td;
            return o || (r = l.full), i(l) ? !1 === (a = S.getById(l, !1, r) || S.objGetById(l)) && (s = l, l = {}) : s = l.name, "map" === s && (a = E), a || (a = [], l.id ? (e.each(g(l.id), function (e, t) {
            ...
            }), l.all || H(s) || (a = a[0]))), a = H(a) || !l.all ? a : [a], o ? a : void f(n, a)
        }, x.exec = function (t) {
            ...
            if (i(t.td)) M.event.trigger(E, t.td); else {
    ...
    var D, M, z = 0, F = e.isFunction, H = e.isArray, N = {}, B = new S;
    e.fn.gmap3 = function () {
        var t, n = [], i = !0, o = [];
        for (s(), t = 0; t < arguments.length; t++) arguments[t] && n.push(arguments[t]);
        return n.length || n.push("map"), e.each(this, function () {
            var t = e(this), r = t.data("gmap3");
            i = !1, r || (r = new Q(t), t.data("gmap3", r)), 1 !== n.length || "get" !== n[0] && !x(n[0]) ? r._plan(n) : "get" === n[0] ? o.push(r.get("map", !0)) : o.push(r.get(n[0].get, !0, n[0].get.full))
    ...
    function i(i, s) {
        function a() {
            if (S) {
                y = t.createElement("canvas"), y.className = "pg-canvas", y.style.display = "block", i.insertBefore(y, i.firstChild), v = y.getContext("2d"), l();
                for (var n = Math.round(y.width * y.height / s.density), o = 0; n > o; o++) {
                    var r = new h;
                    r.setStackPos(o), C.push(r)
                }
                e.addEventListener("resize", function () {
                    c()
                }, !1), t.addEventListener("mousemove", function (e) {
                    k = e.pageX, j = e.pageY
                }, !1), I && !_ && e.addEventListener("deviceorientation", function () {
        ...
        function l() {
            y.width = i.offsetWidth, y.height = i.offsetHeight, v.fillStyle = s.dotColor, v.strokeStyle = s.lineColor, v.lineWidth = s.lineWidth
        }

        function u() {
            if (S) {
                w = e.innerWidth, T = e.innerHeight, v.clearRect(0, 0, y.width, y.height);
        ...
        function g() {
            console.log("destroy"), y.parentNode.removeChild(y), m("onDestroy"), r && r(i).removeData("plugin_" + o)
        }
        ...
        var y, v, b, w, T, x, P, S = !!t.createElement("canvas").getContext, C = [], k = 0, j = 0,
            _ = !navigator.userAgent.match(/(iPhone|iPod|iPad|Android|BlackBerry|BB10|mobi|tablet|opera mini|nexus 7)/i),
            I = !!e.DeviceOrientationEvent, Y = 0, O = 0, E = !1;
        return s = n({}, e[o].defaults, s), h.prototype.draw = function () {
            v.beginPath(), v.arc(this.position.x + this.parallaxOffsetX, this.position.y + this.parallaxOffsetY, s.particleRadius / 2, 0, 2 * Math.PI, !0), v.closePath(), v.fill(), v.beginPath();
            for (var e = C.length - 1; e > this.stackPos; e--) {
                var t = C[e], n = this.position.x - t.position.x, i = this.position.y - t.position.y;
            ...
            if (s.parallax) {
                ...
                this.parallaxTargX = (x - w / 2) / (s.parallaxMultiplier * this.layer), this.parallaxOffsetX += (this.parallaxTargX - this.parallaxOffsetX) / 10, this.parallaxTargY = (P - T / 2) / (s.parallaxMultiplier * this.layer), this.parallaxOffsetY += (this.parallaxTargY - this.parallaxOffsetY) / 10
            }
            ...
            this.stackPos = e
        }, a(), {option: f, destroy: g, start: p, pause: d}
    }

    var o = "particleground", r = e.jQuery;
    e[o] = function (e, t) {
        return new i(e, t)
    }, e[o].defaults = {
        minSpeedX: .1,
...
var canvasID = "particles", canvas = document.getElementById(canvasID);
if (canvas) {
    var $headerSizer, width, height, ctx, circles, animateHeader = !0;
    $headerSizer = $(".full-slider"), initHeader(), addListeners()
}